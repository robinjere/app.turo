...
class HouzezParser implements ApiParserInterface {
  ...
  static Article parseArticleMap(Map<String, dynamic> json) {
    ...
    if (json.containsKey("additional_details")) {
      MembershipPlanDetails membershipPlanDetails =
          MembershipPlanDetails.fromJson(json['additional_details']);
  ...
  ApiResponse<String> parse500ApiResponse(Response response) {
      ...
      if (response.statusCode == HttpStatus.ok ||
        ...
        if (map.containsKey("success") && map["success"]) {
          ...
          return ApiResponse<String>(
              false, map["reason"] as String, map["reason"] as String);
        }
    ...
    return ApiResponse<String>(
        false, "", response.statusMessage ?? "Unknown error");
  }
    ...
    if (map != null) {
      if (response.statusCode == 500) {
        if (map.containsKey("success") && map["success"]) {
          ...
          return ApiResponse<String>(
              false, "", "Error while making property featured");
        }
      }
    }
  ...
  CheckNotifications parseCheckNotificationsResponse(
    ...
    return CheckNotifications(
      ...
      lastCheckedNotificationString: json["last_checked_notification"] is String
          ? json["last_checked_notification"]
          : null,
      lastCheckedNotificationDateTime:
          (json["last_checked_notification"] == null ||
                  json["last_checked_notification"] is! String)
              ? null
              : DateTime.parse(json["last_checked_notification"]),
    );
  }
}
