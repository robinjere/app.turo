...
import 'package:turo_package/models/custom_fields.dart';
...
class PropertyRepository {
  ...
  Future<ApiResponse> fetchContactRealtorResponse(
    ...
    final response = await propertyApiProvider.fetchContactRealtorResponse(
  ...
  Future<Response> fetchAdminAddUserResponse(
      Map<String, dynamic> dataMap, String nonce) async {
    final response =
        await propertyApiProvider.fetchAdminAddUserResponse(dataMap, nonce);
    return response;
  }
  ...
  Future<ApiResponse> fetchDeleteAgentResponse(
    ...
    final response =
        await propertyApiProvider.fetchDeleteAgentResponse(dataObj, nonce);
    return response;
  }
  ...
  Future<ApiResponse> fetchApproveDisapproveResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchApproveDisapproveResponse(dataMap);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> fetchToggleFeaturedResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchToggleFeaturedResponse(dataMap);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> fetchSetSoldStatusResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchSetSoldStatusResponse(dataMap);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> fetchSetExpiredStatusResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchSetExpiredStatusResponse(dataMap);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> fetchSetPendingStatusResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchSetPendingStatusResponse(dataMap);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }

  Future<(bool, bool, BlogArticlesData?)> fetchBlogArticlesData(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchBlogFilteredArticlesResponse(dataMap);
  ...
  Future<(bool, BlogCategoriesData?)> fetchBlogAllCategoriesData(
      String orderBy, String order) async {
    final response = await propertyApiProvider.fetchBlogAllCategoriesResponse(
        orderBy, order);
  ...
  Future<(bool, BlogTagsData?)> fetchBlogAllTagsData(
      String orderBy, String order) async {
    final response =
        await propertyApiProvider.fetchBlogAllTagsResponse(orderBy, order);
    ...
    BlogTagsData data =
        propertyApiProvider.getCurrentParser().parseBlogTagsJson(response.data);

    return (true, data);
  }

  Future<(bool, bool, BlogCommentsData?)> fetchBlogAllCommentsData(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchBlogArticleCommentsResponse(dataMap);
  ...
  Future<ApiResponse> fetchBlogAddCommentResponse(
      Map<String, dynamic> dataMap, String nonce) async {
    final response =
        await propertyApiProvider.fetchBlogAddCommentResponse(dataMap, nonce);
    ApiResponse<String> apiResponse =
        propertyApiProvider.getCurrentParser().parseNormalApiResponse(response);
    return apiResponse;
  }

  Future<(bool, bool, AllNotifications?)> fetchAllNotificationsResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchAllNotificationsResponse(dataMap);
  ...
  Future<(bool, bool, CheckNotifications?)> fetchCheckNotificationsResponse(
      Map<String, dynamic> dataMap) async {
    final response =
        await propertyApiProvider.fetchCheckNotificationsResponse(dataMap);
