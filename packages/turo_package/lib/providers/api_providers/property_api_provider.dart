...
import 'package:turo_package/interfaces/api_parser_interface.dart';
import 'package:turo_package/interfaces/api_provider_interface.dart';
import 'package:turo_package/models/api/api_request.dart';
...
class PropertyApiProvider {
  ...
  Dio getDio({bool isNonce = false, bool forceExcludeCache = false}) {
    ...
    Map<String, dynamic> headerHookMap =
        HiveStorageManager.readSecurityKeyMapData() ?? {};
  ...
  Future<Response> doRequestOnRoute(
    ...
    try {
      ...
      if (type == GET) {
        ...
        var response =
            await dio.postUri(uri, data: FormData.fromMap(dataMap ?? {}));
        return response;
      }
      ...
      if (dioError.response != null) {
          ...
          if (dioError.response != null) {
            if (tag == "add or remove from favourites") {
              ...
              if (dioError.response!.statusCode == 500 &&
                  (tempResponse.contains(temp1) ||
                      tempResponse.contains(temp2))) {
                return dioError.response!;
              }
            } else if (tag == "delete image from edit property" ||
                tag == "sign-up") {
              return dioError.response!;
            } else {
              var tempResponse = dioError.response.toString();
        ...
        if (handle403) {
          if (dioError.response!.statusCode! == 403 ||
            ...
            if (tries <= MAX_TRIES) {
              await refreshToken();
              return doRequestOnRoute(uri,
                  type: type, dataMap: dataMap, tag: tag, tries: ++tries);
            }
          }
        }
  ...
  Future<Response> fetchLatestArticlesResponse(int page) async {
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: data, tag: "latest article");
  }

  Future<Response> fetchFilteredArticlesResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _apiProviderInterface.provideFilteredPropertiesApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "filtered article");
  }
  ...
  Future<Response> fetchSingleArticleResponse(int id,
      {bool forEditing = false}) async {
    var uri = _apiProviderInterface.provideSinglePropertyApi(id,
  ...
  Future<Response> fetchAgencyAllAgentListApi(int agencyId) async {
    ...
    return doRequestOnRoute(uri,
        tag: "agency all agent info", forceExcludeCache: true);
  }

  Future<Response> fetchPropertiesByAgencyApi(
      int id, int page, int perPage) async {
    var uri =
        _apiProviderInterface.providePropertiesByAgencyApi(id, page, perPage);
    return doRequestOnRoute(uri, tag: "agency properties");
  }

  Future<Response> fetchPropertiesByAgentApi(
      int id, int page, int perPage) async {
    var uri =
        _apiProviderInterface.providePropertiesByAgentApi(id, page, perPage);
  ...
  Future<Response> fetchPropertiesInCityApi(
      int cityId, int page, int perPage) async {
    var uri =
        _apiProviderInterface.providePropertiesInCityApi(cityId, page, perPage);
    return doRequestOnRoute(uri, tag: "city properties");
  }

  Future<Response> fetchPropertiesInCityByTypeApi(
      int cityId, int typeId, int page, int perPage) async {
    var uri = _apiProviderInterface.providePropertiesInCityByTypeApi(
        cityId, typeId, page, perPage);
    return doRequestOnRoute(uri, tag: "city properties by type");
  }

  Future<Response> fetchPropertiesByTypeApi(
      int propertyTypeId, int page, int perPage) async {
    var uri = _apiProviderInterface.providePropertiesByTypesApi(
        propertyTypeId, page, perPage);
  ...
  Future<ApiResponse> fetchContactRealtorResponse(
    ...
    ApiResponse apiResponse =
        _apiProviderInterface.getParser().parse500ApiResponse(response);
    return apiResponse;
  }
  ...
  Future<Response> fetchContactDeveloperResponse(
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "contact dev");
  }
  ...
  Future<Response> fetchLoginResponse(Map<String, dynamic> dataMap) async {
    ...
    return doRequestOnRoute(request.uri,
        dio: dio,
        type: POST,
        dataMap: request.params,
        tag: "login",
        handle403: false);
  }

  Future<Response> fetchSignUpResponse(
      Map<String, dynamic> dataMap, String nonce) async {
  ...
  Future<Response> fetchAllProperties(
      String status, int page, int perPage, int? userId,
      {Map<String, dynamic>? options}) async {
    var uri = _apiProviderInterface.provideAllPropertiesApi(
  ...
  Future<Response> statusOfProperty(
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "prop status");
  }
  ...
  Future<Response> fetchMyProperties(
      String status, int page, int perPage, int userId,
      {Map<String, dynamic>? options}) async {
    var uri = _apiProviderInterface.provideMyPropertiesApi(
        status, page, perPage, userId);
  ...
  Future<Response> fetchAddOrRemoveFromFavResponse(
    ...
    return doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "add or remove from favourites",
        handle500: true);
  }

  Future<Uri> fetchPrintPdfPropertyResponse(
      Map<String, dynamic> dataMap) async {
  ...
  Future<Response> fetchFavProperties(
      int page, int perPage, String userIdStr) async {
    var uri =
        _apiProviderInterface.provideFavPropertiesApi(page, perPage, userIdStr);
    return doRequestOnRoute(uri,
        tag: "get fav prop", useCache: false, handle403: true);
  }
  ...
  Future<Response> fetchLatLongArticlesResponse(
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: data, tag: "property on loc");
  }
  ...
  Future<Response> fetchSavedSearches(int page, int perPage,
  ...
  Future<Response> fetchDeleteSavedSearch(Map<String, dynamic> dataMap) async {
    ...
    return doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "delete saved property",
        handle500: true);
  }

  Future<Response> fetchSavedSearchArticlesResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _apiProviderInterface.provideSavedSearchArticlesApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "saved search articles");
  }
  ...
  Future<Response> fetchArticlesReviewsResponse(
      int id, String page, String perPage) async {
    var uri =
        _apiProviderInterface.provideArticlesReviewsApi(id, page, perPage);
    return doRequestOnRoute(uri, tag: "article reviews");
  }

  Future<Response> fetchAgentAgencyAuthorReviewsResponse(
      int id, String page, String perPage, String type) async {
    var uri = _apiProviderInterface.provideAgentAgencyAuthorReviewsApi(
        id, page, perPage, type);
  ...
  Future<Response> fetchUpdateUserProfileImageResponse(
    ...
    return doRequestOnRoute(uri,
        type: POST,
        formData: formData,
        tag: "update user profile image",
        handle500: true);
  }

  Future<Response> fetchSearchAgentsApi(int page, int perPage, String search,
      String agentCity, String agentCategory) async {
    var uri = _apiProviderInterface.provideSearchAgentsApi(
        page, perPage, search, agentCity, agentCategory);
    return doRequestOnRoute(uri, tag: "search agents");
  }

  Future<Response> fetchSearchAgenciesApi(
      int page, int perPage, String search) async {
    var uri =
        _apiProviderInterface.provideSearchAgenciesApi(page, perPage, search);
  ...
  Future<Response> fetchFixProfileImageResponse() async {
    ...
    return doRequestOnRoute(uri,
        type: POST, tag: "update user profile", handle500: true);
  }
  ...
  Future<Response> fetchIsFavPropertyApi(String listingId) async {
    ...
    return doRequestOnRoute(uri,
        tag: "is fav property", forceExcludeCache: true);
  }

  Future<Response> fetchSocialSignOnResponse(
      Map<String, dynamic> dataMap) async {
    ApiRequest apiRequest =
        _apiProviderInterface.provideSocialLoginApi(dataMap);
    Dio dio = Dio();
    // ..interceptors.add(DioCacheManager(CacheConfig()).interceptor);
    return doRequestOnRoute(apiRequest.uri,
        dio: dio,
        type: POST,
        dataMap: apiRequest.params,
        tag: "social-login",
        handle403: false);
  }

  Future<Response> fetchPropertiesByTypeResponse(
      int page, int id, String type) async {
  ...
  Future<Response> fetchDeleteUserAccountResponse() async {
    ...
    return doRequestOnRoute(uri,
        type: POST, tag: "delete user account", handle500: true);
  }
  ...
  Future<Response> fetchSingleArticleViaPermaLinkResponse(
      String permaLink) async {
    var uri =
        _apiProviderInterface.provideSingleArticleViaPermaLinkApi(permaLink);
    String str = uri.toString();
    str = UtilityMethods.parseHtmlString(str);
  ...
  Future<Response> fetchAddRequestPropertyResponse(
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "request property", handle500: true);
  }
  ...
  Future<Response> fetchUsersResponse(
      int page, int perPage, String search) async {
    Uri uri =
        _apiProviderInterface.provideUsersResponseApi(page, perPage, search);
  ...
  Future<ApiResponse> fetchProceedWithPaymentsResponse(
    ...
    Response response = await doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "Proceed With Payments",
        handle403: false);

    ApiResponse<String> apiResponse =
        _apiProviderInterface.getParser().parsePaymentResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> fetchMakePropertyFeaturedResponse(
    ...
    Response response = await doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "Make Property Featured",
        handle500: true);

    ApiResponse<String> apiResponse =
        _apiProviderInterface.getParser().parseFeaturedResponse(response);
    return apiResponse;
  }
  ...
  Future<ApiResponse> createNonce(String nonceName,
    ...
    ApiResponse<String> nonce =
        _apiProviderInterface.getParser().parseNonceResponse(response);
    return nonce;
  }
  ...
  Future<Response> fetchApproveDisapproveResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideApproveDisapproveResponseApi();

    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Approve Disapprove");
  }

  Future<Response> fetchToggleFeaturedResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideToggleFeaturedResponseApi();

    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Toggle Featured");
  }

  Future<Response> fetchSetSoldStatusResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideSetSoldStatusResponseApi();

    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Set sold status");
  }

  Future<Response> fetchSetExpiredStatusResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideSetExpiredStatusResponseApi();

    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Set expire status");
  }

  Future<Response> fetchSetPendingStatusResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideSetPendingStatusResponseApi();

    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Set pending status");
  }

  Future<Response> fetchBlogFilteredArticlesResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _apiProviderInterface.provideBlogSearchApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "blog filtered articles");
  }

  Future<Response> fetchBlogAllCategoriesResponse(
  ...
  Future<Response> fetchBlogAllTagsResponse(
      String orderBy, String order) async {
    var uri = _apiProviderInterface.provideBlogAllTagsApi(orderBy, order);
    return doRequestOnRoute(uri, tag: "blog tags");
  }

  Future<Response> fetchBlogArticleCommentsResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _apiProviderInterface.provideBlogCommentsApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "blog article comments");
  }

  Future<Response> fetchBlogAddCommentResponse(
      Map<String, dynamic> dataMap, String nonce) async {
  ...
  Future<Response> fetchAllNotificationsResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideAllNotificationsApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "All Notifications");
  }

  Future<Response> fetchCheckNotificationsResponse(
      Map<String, dynamic> dataMap) async {
    Uri uri = _apiProviderInterface.provideCheckNotificationsApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Check Notifications");
  }
}
