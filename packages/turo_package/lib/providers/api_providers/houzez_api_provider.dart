...
import 'package:turo_package/parsers/houzez_parser.dart';
...
const String HOUZEZ_NEW_ALL_PROPERTIES_PATH =
    "/wp-json/houzez-mobile-api/v1/all-properties";
...
const String HOUZEZ_PROCEED_WITH_PAYMENT_PATH =
    "/wp-json/houzez-mobile-api/v1/proceed-with-payment";
const String HOUZEZ_MAKE_PROPERTY_FEATURED_PATH =
    "/wp-json/houzez-mobile-api/v1/make-property-featured";
const String HOUZEZ_REMOVE_FROM_FEATURED_PATH =
    "/wp-json/houzez-mobile-api/v1/remove-from-featured";
const String HOUZEZ_USER_MEMBERSHIP_CURRENT_PACKAGE_PATH =
    "/wp-json/houzez-mobile-api/v1/user-current-package";
const String HOUZEZ_APPROVE_DISAPPROVE_PATH =
    "/wp-json/houzez-mobile-api/v1/admin-approve-disapprove";
const String HOUZEZ_TOGGLE_FEATURED_PATH =
    "/wp-json/houzez-mobile-api/v1/toggle-featured";
const String HOUZEZ_SOLD_LISTING_PATH =
    "/wp-json/houzez-mobile-api/v1/sold-listing";
const String HOUZEZ_EXPIRE_LISTING_PATH =
    "/wp-json/houzez-mobile-api/v1/expire-listing";
const String HOUZEZ_PENDING_LISTING_PATH =
    "/wp-json/houzez-mobile-api/v1/pending-listing";
const String ADMIN_ADD_USER_API_LINK_PATH =
    "/wp-json/houzez-mobile-api/v1/add-user";
const String ALL_NOTIFICATIONS_PATH =
    "/wp-json/houzez-mobile-api/v1/all-notifications";
const String CHECK_NOTIFICATIONS_PATH =
    "/wp-json/houzez-mobile-api/v1/check-notifications";

/// Blogs related
const String HOUZEZ_BLOGS_SEARCH_API_PATH =
    "/wp-json/houzez-mobile-api/v1/search-articles";
const String HOUZEZ_BLOGS_ALL_CATEGORIES_API_PATH =
    "/wp-json/houzez-mobile-api/v1/all-categories";
const String HOUZEZ_BLOGS_ALL_TAGS_API_PATH =
    "/wp-json/houzez-mobile-api/v1/all-tags";
const String HOUZEZ_BLOGS_ALL_COMMENTS_API_PATH =
    "/wp-json/houzez-mobile-api/v1/article-comments";
const String HOUZEZ_BLOGS_ADD_COMMENT_API_PATH =
    "/wp-json/houzez-mobile-api/v1/add-comment";
...
class HOUZEZApiProvider implements ApiProviderInterface {
  ...
  Uri getUri({required String unEncodedPath, Map<String, dynamic>? params}) {
    ...
    DefaultLanguageCodeHook defaultLanguageCodeHook =
        HooksConfigurations.defaultLanguageCode;
    ...
    } else if (currentSelectedLocaleUrlPosition ==
        defaultLangOnUrlAndSecondaryLangAsDirectory) {
  ...
  Uri providePrintPdfPropertyApi(Map<String, dynamic> dataMap) {
    var uri =
        getUri(unEncodedPath: HOUZEZ_PRINT_PDF_PROPERTY_PATH, params: dataMap);
    return uri;
  }
