...
typedef MarkerTitleHook = String Function(
    BuildContext context, Article article);
typedef MarkerIconHook = String? Function(
    BuildContext context, Article article);
typedef DrawerWidgetsHook = Widget? Function(
    BuildContext context, String hookName);
typedef NavbarWidgetsHook = Widget? Function(
    BuildContext context, String hookName);
typedef PriceFormatterHook = String? Function(
    String propertyPrice, String firstPrice);
typedef HomeSliverAppBarBodyHook = Map<String, dynamic>? Function(
    BuildContext context);
typedef PropertyItemHook = Widget? Function(
    BuildContext buildContext, Article article);
...
typedef CustomMarkerHook = MapMarkerData? Function(
    BuildContext context, Article article);
typedef HomeWidgetsHook = Widget? Function(
...
typedef PropertyPageWidgetsHook = Widget? Function(
    BuildContext context, Article article, String hook);
typedef PaymentSuccessfulHook = void Function(
    BuildContext context, bool success);
typedef MembershipPackageUpdatedHook = void Function(
    BuildContext context, bool updated);
typedef MembershipPayWallDesignHook = String Function(BuildContext context);
typedef MembershipPlanHook = Widget? Function(
...
typedef CustomClusterMarkerIconHook = Future<BitmapDescriptor>? Function(
...
class HooksConfigurations {
  ...
  static void setHooks(Map<String, dynamic> hooksMap) {
    if (hooksMap.isNotEmpty) {
      ...
      if (hooksMap.containsKey("drawerItems") &&
          hooksMap["drawerItems"] != null) {
        drawerItemsList = hooksMap["drawerItems"];
      }

      if (hooksMap.containsKey("widgetItems") &&
          hooksMap["widgetItems"] != null) {
        widgetItem = hooksMap["widgetItems"];
      }

      if (hooksMap.containsKey("propertyItem") &&
          hooksMap["propertyItem"] != null) {
        propertyItem = hooksMap["propertyItem"];
      }

      if (hooksMap.containsKey("propertyItemV2") &&
          hooksMap["propertyItemV2"] != null) {
        propertyItemV2 = hooksMap["propertyItemV2"];
      }

      if (hooksMap.containsKey("propertyItemHeightHook") &&
          hooksMap["propertyItemHeightHook"] != null) {
      ...
      if (hooksMap.containsKey("agencyItem") &&
          hooksMap["agencyItem"] != null) {
        agencyItem = hooksMap["agencyItem"];
      }

      if (hooksMap.containsKey("languageNameAndCode") &&
          hooksMap["languageNameAndCode"] != null) {
        languageNameAndCode = hooksMap["languageNameAndCode"];
      }

      if (hooksMap.containsKey("defaultLanguageCode") &&
          hooksMap["defaultLanguageCode"] != null) {
        defaultLanguageCode = hooksMap["defaultLanguageCode"];
      }

      if (hooksMap.containsKey("defaultHomePage") &&
          hooksMap["defaultHomePage"] != null) {
        defaultHomePage = hooksMap["defaultHomePage"];
      }

      if (hooksMap.containsKey("defaultCountryCode") &&
          hooksMap["defaultCountryCode"] != null) {
        defaultCountryCode = hooksMap["defaultCountryCode"];
      }

      if (hooksMap.containsKey("settingsOption") &&
          hooksMap["settingsOption"] != null) {
        settingsOption = hooksMap["settingsOption"];
      }

      if (hooksMap.containsKey("profileItem") &&
          hooksMap["profileItem"] != null) {
        profileItem = hooksMap["profileItem"];
      }

      if (hooksMap.containsKey("homeRightBarButtonWidget") &&
          hooksMap["homeRightBarButtonWidget"] != null) {
        homeRightBarButtonWidget = hooksMap["homeRightBarButtonWidget"];
      }

      if (hooksMap.containsKey("markerTitle") &&
          hooksMap["markerTitle"] != null) {
        markerTitle = hooksMap["markerTitle"];
      }

      if (hooksMap.containsKey("markerIcon") &&
          hooksMap["markerIcon"] != null) {
        markerIcon = hooksMap["markerIcon"];
      }
      if (hooksMap.containsKey("customMapMarker") &&
          hooksMap["customMapMarker"] != null) {
        customMapMarker = hooksMap["customMapMarker"];
      }

      if (hooksMap.containsKey("priceFormatter") &&
          hooksMap["priceFormatter"] != null) {
        priceFormat = hooksMap["priceFormatter"];
      }

      if (hooksMap.containsKey("compactPriceFormatter") &&
          hooksMap["compactPriceFormatter"] != null) {
        compactPriceFormatter = hooksMap["compactPriceFormatter"];
      }

      if (hooksMap.containsKey("textFormFieldCustomizationHook") &&
          hooksMap["textFormFieldCustomizationHook"] != null) {
        textFormFieldCustomizationHook =
            hooksMap["textFormFieldCustomizationHook"];
      }

      if (hooksMap.containsKey("textFormFieldWidgetHook") &&
          hooksMap["textFormFieldWidgetHook"] != null) {
        textFormFieldWidgetHook = hooksMap["textFormFieldWidgetHook"];
      }

      if (hooksMap.containsKey("customSegmentedControlHook") &&
          hooksMap["customSegmentedControlHook"] != null) {
        customSegmentedControlHook = hooksMap["customSegmentedControlHook"];
      }

      if (hooksMap.containsKey("drawerHeaderHook") &&
          hooksMap["drawerHeaderHook"] != null) {
        drawerHeaderHook = hooksMap["drawerHeaderHook"];
      }

      if (hooksMap.containsKey("hidePriceHook") &&
          hooksMap["hidePriceHook"] != null) {
        hidePriceHook = hooksMap["hidePriceHook"];
      }

      if (hooksMap.containsKey("hideEmptyTerm") &&
          hooksMap["hideEmptyTerm"] != null) {
      ...
      if (hooksMap.containsKey("membershipPlanHook") &&
          hooksMap["membershipPlanHook"] != null) {
        membershipPlanHook = hooksMap["membershipPlanHook"];
      }

      if (hooksMap.containsKey("paymentHook") &&
          hooksMap["paymentHook"] != null) {
        paymentHook = hooksMap["paymentHook"];
      }

      if (hooksMap.containsKey("membershipPackageUpdatedHook") &&
          hooksMap["membershipPackageUpdatedHook"] != null) {
        membershipPackageUpdatedHook = hooksMap["membershipPackageUpdatedHook"];
      }

      if (hooksMap.containsKey("paymentSuccessfulHook") &&
          hooksMap["paymentSuccessfulHook"] != null) {
        paymentSuccessfulHook = hooksMap["paymentSuccessfulHook"];
      }

      if (hooksMap.containsKey("addPlusButtonInBottomBarHook") &&
          hooksMap["addPlusButtonInBottomBarHook"] != null) {
        addPlusButtonInBottomBarHook = hooksMap["addPlusButtonInBottomBarHook"];
      }

      if (hooksMap.containsKey("navbarWidgetsHook") &&
          hooksMap["navbarWidgetsHook"] != null) {
        navbarWidgetsHook = hooksMap["navbarWidgetsHook"];
      }

      if (hooksMap.containsKey("clusterMarkerIconHook") &&
          hooksMap["clusterMarkerIconHook"] != null) {
        clusterMarkerIconHook = hooksMap["clusterMarkerIconHook"];
      }

      if (hooksMap.containsKey("customClusterMarkerIconHook") &&
          hooksMap["customClusterMarkerIconHook"] != null) {
        customClusterMarkerIconHook = hooksMap["customClusterMarkerIconHook"];
      }

      if (hooksMap.containsKey("membershipPayWallDesignHook") &&
          hooksMap["membershipPayWallDesignHook"] != null) {
        membershipPayWallDesignHook = hooksMap["membershipPayWallDesignHook"];
      }

      if (hooksMap.containsKey("minimumPasswordLengthHook") &&
          hooksMap["minimumPasswordLengthHook"] != null) {
        minimumPasswordLengthHook = hooksMap["minimumPasswordLengthHook"];
      }

      if (hooksMap.containsKey("agentProfileConfigurationsHook") &&
          hooksMap["agentProfileConfigurationsHook"] != null) {
        agentProfileConfigurationsHook =
            hooksMap["agentProfileConfigurationsHook"];
      }

      if (hooksMap.containsKey("userLoginActionHook") &&
          hooksMap["userLoginActionHook"] != null) {
        userLoginActionHook = hooksMap["userLoginActionHook"];
      }

      if (hooksMap.containsKey("addPropertyActionHook") &&
          hooksMap["addPropertyActionHook"] != null) {
        addPropertyActionHook = hooksMap["addPropertyActionHook"];
      }

      if (hooksMap.containsKey("drawerMenuItemDesignHook") &&
          hooksMap["drawerMenuItemDesignHook"] != null) {
