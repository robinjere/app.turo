...
import 'package:turo_package/files/item_design_files/design_storage_manager.dart';
...
class ItemDesignNotifier with ChangeNotifier {
  ...
  ItemDesignNotifier() {
    _homeScreenItemDesign =
        ItemDesignStorageManager.readItemDesignData(HOME_SCREEN_ITEM_DESIGN) ??
            DESIGN_01;
    _exploreByTypeItemDesign = ItemDesignStorageManager.readItemDesignData(
            EXPLORE_BY_TYPE_ITEM_DESIGN) ??
        DESIGN_01;
    notifyListeners();
  }
  ...
  void setHomeScreenItemDesign(String itemDesign) {
    ...
    ItemDesignStorageManager.saveItemDesignData(
        HOME_SCREEN_ITEM_DESIGN, itemDesign);
    notifyListeners();
  }
  ...
  void setExploreByTypeItemDesign(String itemDesign) {
    ...
    ItemDesignStorageManager.saveItemDesignData(
        EXPLORE_BY_TYPE_ITEM_DESIGN, itemDesign);
    notifyListeners();
  }
}
