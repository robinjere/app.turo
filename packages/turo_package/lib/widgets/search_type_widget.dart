...
import 'package:turo_package/files/generic_methods/string_ext.dart';
...
Widget searchTypeWidget({
  ...
  if (!shouldCupertinoSlider) {
    ...
    for (var element in labels) {
      _minWidth = max(
          _minWidth,
          element.textWidth(AppThemePreferences()
              .appTheme
              .bodyTextStyle!
    ...
    return SingleChildScrollView(
      ...
      child: ToggleSwitch(
        ...
        fontSize: fontSize,
        inactiveBgColor:
            AppThemePreferences().appTheme.switchUnselectedBackgroundColor,
        inactiveFgColor:
            AppThemePreferences().appTheme.switchUnselectedItemTextColor,
        activeFgColor:
            AppThemePreferences().appTheme.switchSelectedItemTextColor,
        activeBgColor: [
