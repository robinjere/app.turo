...
class DynamicTermsWithIconWidget extends StatefulWidget {
  ...
  @override
  State<DynamicTermsWithIconWidget> createState() =>
      _DynamicTermsWithIconWidgetState();
}

class _DynamicTermsWithIconWidgetState
    extends State<DynamicTermsWithIconWidget> {
  late double width;
  late double height;
