...
import 'package:turo_package/pages/home_screen_drawer_menu_pages/user_related/all_users.dart';
import 'package:turo_package/pages/home_screen_drawer_menu_pages/user_related/manage_profile.dart';
...
import 'package:turo_package/widgets/user_profile_related/app_info_widget.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (profileHook != null && profileHook!(context).isNotEmpty)
            CardWidget(
              shape: AppThemePreferences.roundedCorners(
                  AppThemePreferences.globalRoundedCornersRadius),
              child: Container(
