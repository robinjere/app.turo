...
typedef PropertyPickerMultiSelectDialogWidgetListener = void Function(
    List<String> listOfSelectedItems);

class PropertyPickerMultiSelectDialogWidget extends StatefulWidget {
  final String title;
  final String selectedItems;
  final PropertyPickerMultiSelectDialogWidgetListener
  ...
  State<StatefulWidget> createState() =>
      PropertyPickerMultiSelectDialogWidgetState();
}

class PropertyPickerMultiSelectDialogWidgetState
    extends State<PropertyPickerMultiSelectDialogWidget> {
  int page = 1;
    ...
    _scrollController.addListener(() {
      if (_scrollController.offset != null &&
        ...
        if (_scrollController.offset ==
          ...
          print(
              "You've reached at the bottom of List...............................");
    ...
    return AlertDialogWidget(
      ...
      content: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: ListTileTheme(
              selectedColor:
                  AppThemePreferences.appPrimaryColor.withOpacity(0.4),
              child: ListBody(
      ...
      actions: <Widget>[
        ...
        TextButtonWidget(
          ...
          onPressed: () {
            widget.propertyPickerMultiSelectDialogWidgetListener(
                selectedItemsList);
  ...
  Widget paginationLoadingWidget() {
    return _showPaginationLoadingWidget
        ? Container(
