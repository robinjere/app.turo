...
class GenericMultiUnitsWidget extends StatefulWidget {
  ...
  @override
  State<GenericMultiUnitsWidget> createState() =>
      _GenericMultiUnitsWidgetState();
}
          ...
          Column(
            children: itemsList.map((dynamicItem) {
              ...
              return GenericMultiUnitsWidgetBody(
                ...
                genericMultiUnitsWidgetBodyListener: (int index,
...
class GenericMultiUnitsWidgetBodyState
    extends State<GenericMultiUnitsWidgetBody> {
  ...
  Widget build(BuildContext context) {
    if (widget.dataMap.isNotEmpty &&
      ...
      _availabilityDateTextController.text =
          widget.dataMap[faveMUAvailabilityDate];
