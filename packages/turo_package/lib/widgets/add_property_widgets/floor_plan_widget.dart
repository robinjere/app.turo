...
import 'package:turo_package/models/floor_plans.dart';
...
typedef GenericFloorPlanWidgetListener = void Function(
    List<FloorPlanElement> updatedItemsList);
          ...
          Column(
            children: itemsList.map((dynamicItem) {
              ...
              return GenericFloorPlanWidgetBody(
                ...
                genericFloorPlanWidgetListener: (int index,
                    Map<String, dynamic> itemDataMap, bool removeItem) {
                  if (removeItem) {
                    if (mounted) {
                      setState(() {
...
class GenericFloorPlanWidgetBodyState
    extends State<GenericFloorPlanWidgetBody> {
  ...
  Widget build(BuildContext context) {
    if (widget.dataMap != null && !(mapEquals(widget.dataMap, tempDataMap))) {
      ...
      _planPricePostFixTextController.text =
          widget.dataMap[favePlanPricePostFix];
              ...
              IconButton(
                onPressed: () {
                  widget.genericFloorPlanWidgetListener(
                      widget.index, widget.dataMap, true);
                },
  ...
  Widget addDescription(BuildContext context) {
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        hintText:
            UtilityMethods.getLocalizedString("enter_the_plan_description"),
  ...
  updateDataMap() {
    widget.genericFloorPlanWidgetListener(widget.index, widget.dataMap, false);
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _propertyImagesList.isNotEmpty
              ? Padding(
