...
typedef GenericAdditionalDetailsWidgetListener = void Function(
    List<DynamicItem> updatedItemsList);
...
class GenericAdditionalDetailsWidget extends StatefulWidget {
  ...
  @override
  State<GenericAdditionalDetailsWidget> createState() =>
      _GenericAdditionalDetailsWidgetState();
}

class _GenericAdditionalDetailsWidgetState
    extends State<GenericAdditionalDetailsWidget> {
          ...
          Column(
            children: itemsList.map((dynamicItem) {
              ...
              return AdditionalDetailsWidgetBody(
                ...
                genericAdditionalDetailsWidgetListener: (int index,
...
class AdditionalDetailsWidgetBody extends StatefulWidget {
  ...
  final AdditionalDetailsWidgetBodyListener
      genericAdditionalDetailsWidgetListener;
...
class GenericAdditionalDetailsWidgetState
    extends State<AdditionalDetailsWidgetBody> {
  ...
  Widget build(BuildContext context) {
    if (widget.dataMap.isNotEmpty &&
        !(mapEquals(widget.dataMap, tempDataMap))) {
      _additionalDetailsTitleTextController.text =
          widget.dataMap[faveAdditionalFeatureTitle];
      _additionalDetailsValueTextController.text =
          widget.dataMap[faveAdditionalFeatureValue];
  ...
  Widget addAdditionalFeatureTitle() {
    return TextFormFieldWidget(
      ...
      hintText:
          UtilityMethods.getLocalizedString("additional_feature_title_hint"),
