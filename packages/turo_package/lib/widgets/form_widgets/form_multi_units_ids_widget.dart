...
typedef GenericFormMultiUnitsIdsFieldWidgetListener = void Function(
...
class GenericFormMultiUnitsIdsFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormMultiUnitsIdsFieldWidget> createState() =>
      _GenericFormMultiUnitsIdsFieldWidgetState();
}

class _GenericFormMultiUnitsIdsFieldWidgetState
    extends State<GenericFormMultiUnitsIdsFieldWidget> {
  String? apiKey;
