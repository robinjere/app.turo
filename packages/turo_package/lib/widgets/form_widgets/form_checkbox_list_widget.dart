...
import 'package:turo_package/widgets/term_checkbox_list_widget.dart';

typedef GenericFormCheckboxListFieldWidgetListener = void Function(
...
class GenericFormCheckboxListFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormCheckboxListFieldWidget> createState() =>
      _GenericFormCheckboxListFieldWidgetState();
}

class _GenericFormCheckboxListFieldWidgetState
    extends State<GenericFormCheckboxListFieldWidget> {
  String? apiKey;
