...
typedef GenericStepperFormFieldWidgetListener = void Function(
...
class GenericFormStepperFieldWidgetState
    extends State<GenericFormStepperFieldWidget> with ValidationMixin {
    ...
    if (infoDataMap != null && apiKey != null && apiKey!.isNotEmpty) {
      if (infoDataMap!.containsKey(apiKey)) {
        ...
        numberController.text =
            infoDataMap![apiKey] ?? numberIntValue.toString();
      }
    }
