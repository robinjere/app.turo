...
typedef GenericFormFloorPlansFieldWidgetListener = void Function(
...
class GenericFormFloorPlansFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormFloorPlansFieldWidget> createState() =>
      _GenericFormFloorPlansFieldWidgetState();
}

class _GenericFormFloorPlansFieldWidgetState
    extends State<GenericFormFloorPlansFieldWidget> {
  String? apiKey;
