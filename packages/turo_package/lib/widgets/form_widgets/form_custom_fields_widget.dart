...
typedef GenericFormCustomFieldWidgetListener = void Function(
...
class GenericFormCustomFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormCustomFieldWidget> createState() =>
      _GenericFormCustomFieldWidgetState();
}

class _GenericFormCustomFieldWidgetState
    extends State<GenericFormCustomFieldWidget> {
