...
class GenericFormMultiUnitsFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormMultiUnitsFieldWidget> createState() =>
      _GenericFormMultiUnitsFieldWidgetState();
}

class _GenericFormMultiUnitsFieldWidgetState
    extends State<GenericFormMultiUnitsFieldWidget> {
  String? apiKey;
