...
import 'package:turo_package/widgets/add_property_widgets/gdpr_agreement_widget.dart';
import 'package:turo_package/widgets/custom_widgets/card_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_additional_details_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_checkbox_list_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_contatct_info_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_custom_fields_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_drop_down_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_floor_plans_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_map_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_media_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_multi_select_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_multi_units_ids_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_multi_units_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_price_placeholder_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_radio_button_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_stepper_widget.dart';
import 'package:turo_package/widgets/form_widgets/form_text_field_widget.dart';
                  ...
                  HeaderWidget(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(
                            color:
                                AppThemePreferences().appTheme.dividerColor!),
                      ),
                    ),
                  ),
    ...
    return Column(
      children: widget.formItemsList.map((houziFormItem) {
        if (showFormItem(houziFormItem)) {
          ...
          index = widget.formItemsList.indexOf(houziFormItem);
          ...
          switch (type) {
            ...
            case formPricePlaceHolderField:
              {
                return GenericFormPricePlaceholderWidget(
                  formItem: houziFormItem,
                  formItemPadding: widget.formItemPadding,
                  infoDataMap: widget.infoDataMap,
                  listener: widget.listener,
