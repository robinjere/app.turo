...
typedef GenericFormPricePlaceholderWidgetListener = Function(
...
class GenericFormPricePlaceholderWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormPricePlaceholderWidget> createState() =>
      _GenericFormPricePlaceholderWidgetState();
}

class _GenericFormPricePlaceholderWidgetState
    extends State<GenericFormPricePlaceholderWidget> {
  bool enablePricePlaceHolder = false;
  Map<String, dynamic> dataMap = {};
  final TextEditingController _pricePlaceHolderTextController =
    ...
    if (tempMap != null) {
      if (tempMap.containsKey(ADD_PROPERTY_PRICE_PLACEHOLDER) &&
        ...
        _pricePlaceHolderTextController.text =
            tempMap[ADD_PROPERTY_PRICE_PLACEHOLDER];
      }
