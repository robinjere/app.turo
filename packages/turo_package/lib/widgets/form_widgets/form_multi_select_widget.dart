...
typedef GenericMultiSelectFormWidgetListener = void Function(
...
class GenericFormMultiSelectWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormMultiSelectWidget> createState() =>
      _GenericFormMultiSelectWidgetState();
}

class _GenericFormMultiSelectWidgetState
    extends State<GenericFormMultiSelectWidget> with ValidationMixin {
  ...
  void didChangeDependencies() {
    if (_selectedItemsNamesList.isNotEmpty) {
      controller.text = UtilityMethods.getLocalizedString(
          getMultiSelectFieldValue(_selectedItemsNamesList));
    }
                            ...
                            builder: (BuildContext context) {
                              return MultiSelectDialogWidget(
                                ...
                                multiSelectDialogWidgetListener:
                                    (List<dynamic> selectedItemsNamesList,
                                        List<dynamic> selectedItemsIdsList) {
                                  _selectedItemsNamesList =
                                      selectedItemsNamesList;
