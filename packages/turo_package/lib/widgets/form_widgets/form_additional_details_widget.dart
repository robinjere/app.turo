...
typedef GenericFormAdditionalDetailsFieldWidgetListener = void Function(
...
class GenericFormAdditionalDetailsFieldWidget extends StatefulWidget {
  ...
  @override
  State<GenericFormAdditionalDetailsFieldWidget> createState() =>
      _GenericFormAdditionalDetailsFieldWidgetState();
}

class _GenericFormAdditionalDetailsFieldWidgetState
    extends State<GenericFormAdditionalDetailsFieldWidget> {
  String? apiKey;
