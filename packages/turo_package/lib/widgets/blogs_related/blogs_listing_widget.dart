...
import 'package:turo_package/widgets/blogs_related/details_related/blog_details_layout.dart';
...
import 'package:turo_package/widgets/blogs_related/blog_utilities.dart';
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              var heroId =
                  "BLOG-${item.id}-${UtilityMethods.getRandomNumber()}-CAROUSEL";
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        BlogArticle item = articlesList[index];
        String heroId =
            "BLOG-${item.id}-${UtilityMethods.getRandomNumber()}-LIST";
        return Container(
          height: BlogUtilities().getLayoutWidgetHeight(design: design),
        ...
        children: [
          CarouselSlider.builder(
            ...
            options: CarouselOptions(
              autoPlay: true,
              height:
                  BlogUtilities().getLayoutWidgetHeight(design: widget.design),
            ...
            itemBuilder: (context, index, realIndex) {
              ...
              String heroId =
                  "BLOG-${item.id}-${UtilityMethods.getRandomNumber()}-SLIDER";
              return Container(
