...
import 'package:turo_package/widgets/blogs_related/details_related/widgets/comments_widgets/all_comments_widgets/all_comments_widgets.dart';
    ...
    if (!isLoggedIn) {
      ...
      if (formKey.currentState!.validate()) {
        ...
        ApiResponse response =
            await _propertyBloc.fetchBlogAddCommentResponse(dataMap, nonce);
        if (mounted) {
          setState(() {
