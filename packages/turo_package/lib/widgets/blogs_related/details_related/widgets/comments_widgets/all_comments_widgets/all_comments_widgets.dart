                ...
                Container(
                  ...
                  child: GenericTextWidget(
                    ...
                    style: AppThemePreferences()
                        .appTheme
                        .blogCommentAuthorNameTextStyle,
                  ),
                ),
                Container(
                  ...
                  child: GenericTextWidget(
                    ...
                    strutStyle: StrutStyle(
                        height: AppThemePreferences.blogCommentContentHeight),
                    style: AppThemePreferences()
                        .appTheme
                        .blogCommentContentTextStyle,
                  ),
                ),
                Container(
                  padding: const EdgeInsets.only(top: 12),
                  child: Row(
                    children: [
                      GenericTextWidget(
                        ...
                        style: AppThemePreferences()
                            .appTheme
                            .blogCommentActionsTextStyle,
                      ),
                      if (role == ROLE_ADMINISTRATOR &&
                          getCommentDate(comment).isNotEmpty)
...
class AllCommentsBottomActionBar extends StatefulWidget {
  ...
  @override
  State<AllCommentsBottomActionBar> createState() =>
      _AllCommentsBottomActionBarState();
}

class _AllCommentsBottomActionBarState extends State<AllCommentsBottomActionBar>
