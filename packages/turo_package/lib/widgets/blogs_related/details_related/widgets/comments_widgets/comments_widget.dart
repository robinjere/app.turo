...
import 'package:turo_package/widgets/blogs_related/design_layouts/blog_layout_widgets.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/comments_widgets/all_comments_page.dart';
...
class BlogDetailsLayoutCommentsWidget extends StatefulWidget {
  ...
  @override
  State<BlogDetailsLayoutCommentsWidget> createState() =>
      _BlogDetailsLayoutCommentsWidgetState();
}

class _BlogDetailsLayoutCommentsWidgetState
    extends State<BlogDetailsLayoutCommentsWidget> {
  String page = "1";
  String perPage = "3";
  String articleId = "";
  ...
  void initState() {
    articleId =
        (widget.article.id) != null ? (widget.article.id!).toString() : "";
  ...
  Future<BlogCommentsData?> fetchCommentsData() async {
    ...
    var (success, internet, commentsData) =
        await _propertyBloc.fetchBlogAllComments(dataMap);
    if (mounted) {
      setState(() {
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      WriteACommentWidget(
                          onPressed: () => onWriteCommentPressed()),
                      ViewAllCommentsWidget(
  ...
  Widget build(BuildContext context) {
    return CardWidget(
      ...
      shape: AppThemePreferences.roundedCorners(
          AppThemePreferences.commentsRoundedCornersRadius),
      child: Container(
