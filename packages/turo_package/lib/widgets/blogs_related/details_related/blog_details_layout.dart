...
import 'package:turo_package/widgets/blogs_related/details_related/widgets/comments_widgets/comments_widget.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/content_widget.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/image_widget.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/info_widget.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/title_widget.dart';
import 'package:turo_package/widgets/blogs_related/details_related/widgets/top_bar_widget.dart';
...
class _BlogDetailsLayoutState extends State<BlogDetailsLayout> {
  ...
  Future<List<BlogDetailPageLayout>> getBlogDetailPageConfigFile() async {
    List<BlogDetailPageLayout> list =
        HiveStorageManager.readBlogDetailConfigListData();
    if (list.isNotEmpty) {
      return list;
    }
    ...
    BlogDetailsPageLayout blogDetailPageLayout =
        BlogDetailsPageLayout.fromRawJson(configJson);
