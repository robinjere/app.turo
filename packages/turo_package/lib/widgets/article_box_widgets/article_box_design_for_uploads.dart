...
class UploadsArticleBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: 270, //270
      padding:
          const EdgeInsets.only(bottom: 7.0, left: 5.0, right: 5.0, top: 3.0),
      child: CardWidget(
              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    'Queued',
                    style:
                        TextStyle(color: AppThemePreferences.appPrimaryColor),
                  )),
                ],
              ),
            ),
          if (isActiveUpload)
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                      child: GenericTextWidget('Uploading ${progress ?? 0} %')),
                ],
              ),
            ),
          if (isActiveUpload)
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          FeaturesWidget(
              item: article, padding: const EdgeInsets.fromLTRB(0, 0, 0, 0)),
...
class ImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool _validURL =
        (imagePath != null && imagePath!.isNotEmpty) ? true : false;
    return SizedBox(
      height: 165,
