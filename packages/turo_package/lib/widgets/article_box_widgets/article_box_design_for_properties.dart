...
import 'package:turo_package/widgets/article_box_widgets/tags_widgets/tag_widget.dart';
...
import 'package:turo_package/widgets/article_box_widgets/tags_widgets/featured_tag_widget.dart';

typedef PropertiesArticleBoxWidgetListener = void Function(
...
class PropertiesArticleBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String _imageUrl = item.imageList != null && item.imageList!.isNotEmpty
        ? item.imageList![0]
        : "";
    ...
    return Positioned(
      ...
      child: status.isEmpty
          ...
          : Container(
              ...
              child: TagWidget(
                  label:
                      UtilityMethods.getLocalizedString(status).toUpperCase()),
            ),
    );
  }
}
