...
import 'package:turo_package/widgets/article_box_widgets/article_box_design_01.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_02.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_03.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_04.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_05.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_06.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_07.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_08.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_09.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_10.dart';
import 'package:turo_package/widgets/article_box_widgets/article_box_design_11.dart';
...
class ArticleBoxDesign {
  ...
  PropertyItemHeightHook propertyItemHeightHook =
      HooksConfigurations.propertyItemHeightHook;
  ...
  Widget getArticleBoxDesign(
    ...
    return getStockArticleBoxDesign(
        design: design,
  ...
  Widget getStockArticleBoxDesign(
    ...
    Map<String, dynamic> _informationDataMap = {
      ...
      AB_PROPERTY_TYPE:
          UtilityMethods.getLocalizedString(_propertyType).toUpperCase(),
      AB_PROPERTY_LABEL: _propertyLabel,
    };

    if (design == DESIGN_01) {
      return ArticleBox01(
          infoDataMap: _informationDataMap, onTap: onTap, isInMenu: isInMenu);
    }
    if (design == DESIGN_02) {
      return ArticleBox02(
          infoDataMap: _informationDataMap, onTap: onTap, isInMenu: isInMenu);
