...
import 'package:turo_package/files/filter_utility_functions/fliter_utilites_functions.dart';
...
import 'package:turo_package/widgets/filter_page_widgets/term_picker_related/term_picker_full_screen.dart';
...
import 'package:turo_package/widgets/generic_popup_menu_widgets.dart';
import 'package:turo_package/widgets/generic_text_widget.dart';
import 'package:turo_package/widgets/search_result_widgets/featured_switch_widget.dart';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (filterChipsRelatedList.isNotEmpty)
                        Row(
        ...
        builder: (BuildContext context) {
          return MultiSelectDialogWidget(
            ...
            multiSelectDialogWidgetListener:
              ...
              print(
                  "Before merging maps widget.chipsSearchDataMap: ${widget.chipsSearchDataMap}");
