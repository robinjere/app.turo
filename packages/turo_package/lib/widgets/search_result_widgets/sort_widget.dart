...
typedef SortMenuWidgetListener = Function(
    {int? currentSortValue, int? previousSortValue, bool? sortFlag});
...
class SortByMenuOptionsWidget extends StatefulWidget {
  ...
  @override
  State<SortByMenuOptionsWidget> createState() =>
      _SortByMenuOptionsWidgetState();
}
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Radio(
                        ...
                        value: sortByOptionsList
                            .indexWhere((option) => item == option),
  ...
  void onSortItemTap(String item) {
    if (mounted) {
      setState(() {
        ...
        currentSortValue =
            sortByOptionsList.indexWhere((element) => item == element);
...
class _SortFirstByWidgetState extends State<SortFirstByWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          if (_sortFirstByItems.isNotEmpty)
            Column(
  ...
  void onTap(int index, bool value) {
    ...
    HiveStorageManager.storeSortFirstByConfigData(
        json.encode(SortFirstByItem.encode(_sortFirstByItems)));
