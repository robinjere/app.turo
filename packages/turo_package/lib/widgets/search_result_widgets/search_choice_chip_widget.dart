    ...
    return Container(
      ...
      child: ChoiceChipWidget(
        avatar: iconData != null
            ? Icon(iconData, color: AppThemePreferences().appTheme.iconsColor)
            : avatar,
        ...
        backgroundColor:
            AppThemePreferences().appTheme.searchPageChoiceChipsBackgroundColor,
        shape: AppThemePreferences.roundedCorners(
          AppThemePreferences.searchPageChoiceChipsRoundedCornersRadius,
