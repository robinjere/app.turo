...
class StringMultiSelectWidget extends StatefulWidget {
  ...
  @override
  State<StringMultiSelectWidget> createState() =>
      _StringMultiSelectWidgetState();
}
    ...
    if (itemsList.isNotEmpty) {
      ...
      if (listLength == 1) {
        dropDownTextController.text =
            UtilityMethods.getLocalizedString(itemsList.toSet().toList().first);
      } else {
...
typedef StringMultiSelectDialogWidgetListener = void Function(
...
class StringMultiSelectDialogWidgetState
    extends State<StringMultiSelectDialogWidget> {
          ...
          child: ListBody(
            children: _dataItemsList.map((item) {
              ...
              return CheckboxListTile(
                ...
                value: checked,
                title:
                    GenericTextWidget(UtilityMethods.getLocalizedString(item)),
