...
class QueryOptionsWidget extends StatelessWidget {
  ...
  onDeleteTap(BuildContext context, Map<String, dynamic> queryMap,
      String dataId, int index) {
          ...
          TextButtonWidget(
            onPressed: () async {
              ...
              final response = await _propertyBloc
                  .fetchDeleteSavedSearch(deleteSavedSearchInfo);
  ...
  onEditTap(BuildContext context, Map<String, dynamic> queryMap) {
    if (queryMap.containsKey(BATHROOMS) &&
        queryMap[BATHROOMS] != null &&
    ...
    if (queryMap.containsKey(BEDROOMS) &&
        queryMap[BEDROOMS] != null &&
