  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        if (queryDataMap["query_status"] != null &&
            queryDataMap["query_status"].isNotEmpty)
          Row(
            children: [
        ...
        if ((queryDataMap["query_status"] == null ||
                queryDataMap["query_status"].isEmpty) &&
            (queryDataMap["query_type"] != null &&
                queryDataMap["query_type"].isNotEmpty))
          Row(
            children: [
              SavedSearchQueryItemDotWidget(),
              SavedSearchQueryDataItemRowWidget(
        ...
        if ((queryDataMap["query_status"] == null ||
                queryDataMap["query_status"].isEmpty) &&
            (queryDataMap["query_type"] == null ||
                queryDataMap["query_type"].isEmpty))
          Row(
            children: [
              SavedSearchQueryItemDotWidget(),
              SavedSearchQueryDataItemRowWidget(
...
class QueryFeaturesDetailsWidget extends StatelessWidget {
  ...
  String getMaxPriceLabel() {
    if (queryDataMap[PRICE_MAX] != null && queryDataMap[PRICE_MAX].isNotEmpty) {
      ...
      if (_metaKeyFiltersMap[favPropertyPriceKey] is Map) {
        String _metaPriceValue =
            _metaKeyFiltersMap[favPropertyPriceKey][metaMaxValueKey];
  ...
  String getMaxAreaLabel() {
    if (queryDataMap[AREA_MAX] != null && queryDataMap[AREA_MAX].isNotEmpty) {
      ...
      if (_metaKeyFiltersMap[favPropertySizeKey] is Map) {
        String _metaSizeValue =
            _metaKeyFiltersMap[favPropertySizeKey][metaMaxValueKey];
  ...
  IconWidget(String value, IconData icon, {EdgeInsetsGeometry? padding}) {
    return Container(
      ...
      child: Icon(
        ...
        size: 18,
        color:
            value == "All" || value == UtilityMethods.getLocalizedString("any")
