...
import 'package:turo_package/widgets/review_related_widgets/review_options_widget.dart';
...
class SingleReviewRow extends StatefulWidget {
  ...
  SingleReviewRow(
      this.reviewDetailMap, this.showDetailedReview, this.reportNonce);
  ...
  Widget build(BuildContext context) {
    ...
    return CardWidget(
      ...
      shape: AppThemePreferences.roundedCorners(
          AppThemePreferences.reviewRoundedCornersRadius),
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: textWidget(
                  UtilityMethods.cleanContent(widget.reviewDetailMap.content),
                  null),
            )
          ],
        ),
