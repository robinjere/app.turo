...
typedef ReviewOptionsWidgetListener = Function({int? contentItemID});
        ...
        actions: <Widget>[
          ...
          TextButtonWidget(
            onPressed: () async {
              ...
              final response = await _propertyBloc.fetchReportContentResponse(
                  deleteSavedSearchInfo, reportNonce);
