...
class _ReviewsWidgetState extends State<ReviewsWidget> {
  ...
  loadData() {
    _futureArticleReviews =
        fetchArticlesReviews(widget.idForReviews, page, perPage);
    if (mounted) setState(() {});
  }
  ...
  Future<List<dynamic>> fetchArticlesReviews(
    ...
    if (widget.fromProperty) {
      ...
      tempList = await _propertyBloc.fetchAgentAgencyAuthorReviews(
          id, page, perPage, widget.type);
    }
  ...
  Widget build(BuildContext context) {
    return isInternetConnected
        ? articleReviews(_futureArticleReviews)
        : Container();
  }

  Widget articleReviews(Future<List<dynamic>>? futureArticleReviews) {
    return futureArticleReviews == null
        ...
        : FutureBuilder<List<dynamic>>(
            ...
            builder: (context, articleSnapshot) {
              if (articleSnapshot.hasData) {
                ...
                String headerReview =
                    UtilityMethods.getLocalizedString("reviews");
  ...
  Widget leaveReviewButtonWidget() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          textWidget(UtilityMethods.getLocalizedString("give_a_review"),
              AppThemePreferences().appTheme.heading01TextStyle!),
          textWidget(
              UtilityMethods.getLocalizedString("tell_others_what_you_think"),
              null),
          Padding(
  ...
  Widget writeReviewsWidget() {
    return TextButtonWidget(
      ...
      child: textWidget(UtilityMethods.getLocalizedString("write_a_review"),
  ...
  Widget seeMoreWidget(String type) {
    return TextButtonWidget(
      ...
      child: textWidget(UtilityMethods.getLocalizedString("view_all"),
          AppThemePreferences().appTheme.readMoreTextStyle),
    );
  }
