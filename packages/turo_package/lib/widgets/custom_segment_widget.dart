...
import 'package:turo_package/widgets/segment_control/sliding_segmented_control.dart';
...
class _SegmentedControlWidgetState extends State<SegmentedControlWidget> {
  CustomSegmentedControlHook customSegmentedControlHook =
      HooksConfigurations.customSegmentedControlHook;
  ...
  Widget buildSegment() {
    return USE_CUPERTINO_SEGMENT_CONTROL
        ? CupertinoSlidingSegmentedControl(
            ...
            thumbColor:
                AppThemePreferences().appTheme.cupertinoSegmentThumbColor!,
            backgroundColor:
                      ...
                      child: GenericTextWidget(
                        ...
                        style: TextStyle(
                          fontSize: widget.fontSize ??
                              AppThemePreferences.tabBarTitleFontSize,
