...
class MultiSelectDialogWidgetState extends State<MultiSelectDialogWidget> {
  ...
  void initState() {
    ...
    if (widget.selectedItemsList != null &&
    ...
    return AlertDialogWidget(
                        ...
                        : Expanded(
                            child: AutoCompleteTextField(
                              ...
                              itemBuilder: (context, item) {
                                return Container(
                                  color:
                                      AppThemePreferences().appTheme.cardColor,
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            Term? obj = UtilityMethods
                                                .getPropertyMetaDataObjectWithItemName(
                                                    dataType:
                                                        widget.objDataType!,
                                                    name: item);

                                            String title =
                                                widget.fromCustomFields
                                                    ? obj!.parent.toString()
                                                    : obj!.name!;
                              ...
                              key: key,
                              suggestions:
                                  _suggestionsList, //termNamesDataList,
                              itemSorter: (a, b) {
            ...
            ListTileTheme(
              child: ListBody(
                children: _parentChildFormatList.map((item) {
                  String title =
                      widget.fromCustomFields ? item.parent : item.name;
      ...
      actions: <Widget>[
        ...
        TextButtonWidget(
          ...
          onPressed: () {
            widget.multiSelectDialogWidgetListener(
