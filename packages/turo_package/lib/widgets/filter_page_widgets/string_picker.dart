...
class _StringPickerState extends State<StringPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pickerType == tabsStringPicker &&
        _selectedItemsList.isNotEmpty) {
      _selectedTermTitle =
          widget.pickerDataList.indexOf(_selectedItemsList.first);
    }
      ...
      children: [
        Expanded(
          child: Wrap(
            spacing: 5.0,
            runSpacing: 6.0,
            children: widget.pickerDataList
                .map<Widget>((item) => ChoiceChipWidget(
                      label: Padding(
