...
typedef FilterSequentialLocationPickerWidgetListener = void Function(
...
class FilterSequentialLocationPickerWidget extends StatefulWidget {
  ...
  @override
  State<FilterSequentialLocationPickerWidget> createState() =>
      _FilterSequentialLocationPickerWidgetState();
}

class _FilterSequentialLocationPickerWidgetState
    extends State<FilterSequentialLocationPickerWidget> {
  ...
  void initState() {
    if (widget.item.locationPickerHierarchyList != null) {
      filterLocationPickerHierarchyList =
          widget.item.locationPickerHierarchyList!;
    }
    loadData();
