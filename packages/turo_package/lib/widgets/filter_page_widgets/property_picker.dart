...
import 'package:turo_package/widgets/custom_widgets/choice_chip_widget.dart';
import 'package:material_segmented_control/material_segmented_control.dart';
// import 'package:flutter_gen/gen_l10n/app_localizations.dart';

import '../generic_text_widget.dart';

typedef PropertyTypePickerListener = void Function(
    String _title,
    List<dynamic> _listOfPropertyTypesSlugs,
...
class _PropertyPickerState extends State<PropertyPicker> {
  ...
  initializeData(Map<String, dynamic> propertyTypesMap,
      List<dynamic> propertyTypesMetaData) {
  ...
  void addTitleSlugToList() {
    if (tempTitleList != null && tempTitleList.isNotEmpty) {
      ...
      int index =
          propertyTypesMetaData.indexWhere((element) => element.name == title);
      if (index != null && index != -1) {
  ...
  onSegmentChosen(int index) {
    ...
    widget.propertyTypePickerListener(tempTitleList[_selectedPropertyTitle!],
        _listOfPropertyTypeSlugs, _listOfPropertyTypes);
  }
                ...
                children: (propertyTypesMap[key])
                    .map<Widget>((item) => Padding(
                          ...
                          child: ChoiceChipWidget(
                            ...
                            selected:
                                _listOfPropertyTypeSlugs.contains(item.slug),
                            ...
                            onSelected: (bool selected) {
                              ...
                              widget.propertyTypePickerListener(
                                  tempTitleList[_selectedPropertyTitle!],
                                  _listOfPropertyTypeSlugs,
                                  _listOfPropertyTypes);
                            },
        ...
        children: [
          Expanded(
            child: SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                children: propertyTypesMetaData
                    .map<Widget>((item) => Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 5.0),
                          child: ChoiceChipWidget(
                            label: Padding(
