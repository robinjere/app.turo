          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                    flex: 3,
                    child: FilterPageDoneButtonWidget(
      ...
      onPressed: () {
        if (dataInitializationMap.isNotEmpty &&
          ...
          if (dataInitializationMap[SELECTED_INDEX_FOR_TAB] == 0) {
            ...
            // }
            if (dataInitializationMap[RADIUS] == null ||
                dataInitializationMap[RADIUS].isEmpty) {
              dataInitializationMap[RADIUS] = "50";
            }
            if (dataInitializationMap[LATITUDE] != null &&
                dataInitializationMap[LONGITUDE] != null &&
                dataInitializationMap[RADIUS] != null) {
        ...
        HiveStorageManager.storeRecentSearchesInfo(
            infoList: recentSearchesList);
