...
import 'package:turo_package/widgets/filter_page_widgets/drop_down_widget.dart';
...
typedef MetaKeyPickerWidgetListener = void Function(
...
class _MetaKeyPickerWidgetState extends State<MetaKeyPickerWidget> {
  ...
  void initState() {
    ...
    if (widget.initializeDataMap[metaKeyFiltersKey] != null &&
      ...
      _metaKeyFiltersDataMap = Map<String, dynamic>.from(
          widget.initializeDataMap[metaKeyFiltersKey]);
    }
  ...
  String getSelectedMinRange(String? dataType) {
    if (dataType != null &&
        _metaKeyFiltersDataMap.containsKey(dataType) &&
      ...
      return _metaKeyFiltersDataMap[dataType][minRangeKey] ??
          rangeSliderMinValue;
    }
  ...
  String getSelectedMaxRange(String? dataType) {
    if (dataType != null &&
      ...
      return _metaKeyFiltersDataMap[dataType][maxRangeKey] ??
          rangeSliderMaxValue;
    }
  ...
  List<String> getSelectedOptionsList(String? dataType) {
    if (dataType != null &&
      ...
      if (_metaKeyFiltersDataMap[dataType][metaValueKey] is List) {
        ...
        List<String> _listHolder =
            UtilityMethods.getListFromString(_valueHolder);
        return _listHolder;
      }
    }
    return [];
