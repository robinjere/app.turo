...
class BlogCommentsData {
  ...
  factory BlogCommentsData.fromRawJson(String str) =>
      BlogCommentsData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory BlogCommentsData.fromJson(Map<String, dynamic> json) =>
      BlogCommentsData(
        ...
        commentsList: json["result"] == null
            ...
            : List<BlogComment>.from(
                json["result"]!.map((x) => BlogComment.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "success": success,
        "count": count,
        "result": commentsList == null
            ? []
