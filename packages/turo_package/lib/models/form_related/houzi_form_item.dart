...
class HouziFormItem {
  ...
  static HouziFormItem parseFormItemJson(
  ...
  static Map<String, dynamic> encodeFormItemToJson(
          {required HouziFormItem formItem}) =>
      {
  ...
  static List<Map<String, dynamic>> encode(List<HouziFormItem> formFieldsList) {
    return formFieldsList
        .map<Map<String, dynamic>>((formField) =>
            HouziFormItem.encodeFormItemToJson(formItem: formField))
        .toList();
  }

  static List<HouziFormItem> decode(List<dynamic> formFieldsEncodedList) {
    return List<HouziFormItem>.from(formFieldsEncodedList
        .map<HouziFormItem>((formFieldJson) =>
            HouziFormItem.parseFormItemJson(json: formFieldJson))
        .toList());
  }
}
...
class FieldValues {
  ...
  FieldValues({this.fieldValuesMap});

  static FieldValues fromJson(Map<String, dynamic> json) =>
      FieldValues(fieldValuesMap: json);
