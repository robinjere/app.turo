import 'package:turo_package/common/houzez_api_key_constants.dart';

abstract class DataModelInterface<T> {
  Map<String, dynamic> convertObjectToMap(T value);
}

/// For page packages/turo_package/lib/pages/send_email_to_realtor.dart
class ContactRealtorRequest
    implements DataModelInterface<ContactRealtorRequest> {
  String agentId;
  String targetEmail;
  String mobile;
  String name;
...
/// For page packages/turo_package/lib/pages/home_screen_drawer_menu_pages/my_agency_agents.dart
