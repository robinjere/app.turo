...
class NotificationItem {
  ...
  String? get descriptionPlain {
    if (_descriptionPlain == null && description != null) {
      ...
      _descriptionPlain = _descriptionPlain?.replaceAll(
          "on https://" + WORDPRESS_URL_DOMAIN, "on " + APP_NAME);
      _descriptionPlain = _descriptionPlain?.replaceAll(
          "on http://" + WORDPRESS_URL_DOMAIN, "on " + APP_NAME);
    }
  ...
  String? get descriptionPlainWithNewLines {
    if (_descriptionPlainNewLines == null && description != null) {
      _descriptionPlainNewLines = description
          ?.trim()
          .replaceAll("on https://" + WORDPRESS_URL_DOMAIN, "on " + APP_NAME);
      _descriptionPlainNewLines = _descriptionPlainNewLines?.replaceAll(
          "on http://" + WORDPRESS_URL_DOMAIN, "on " + APP_NAME);
    }
