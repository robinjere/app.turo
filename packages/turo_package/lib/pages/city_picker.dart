...
typedef CityPickerListener = void Function(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () {
                                      if (item == "All") {
                                        ...
                                        _selectedCity = item;
                                        int index = cityNamesDataList
                                            .indexOf(_selectedCity);
                                        if (index != -1) {
                                          _selectedCityId =
                                              cityDataList[index].id;
                                          String citySlug =
                                              cityDataList[index].slug;
                                          widget.cityPickerListener!(
                                              _selectedCity,
                                              _selectedCityId!,
                                              citySlug);
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    if (cityDataList[index].name == "All") {
                                      ...
                                      _selectedCity = cityDataList[index]
                                          .name; //widget.citiesMetaDataMap[index].name;
                                      _selectedCityId = cityDataList[index].id;
                                      String citySlug =
                                          cityDataList[index].slug;
                                      widget.cityPickerListener!(_selectedCity,
                                          _selectedCityId!, citySlug);
                                    }
                                    Navigator.of(context).pop();
                                  },
                                ),
