...
import 'package:turo_package/widgets/notifications_widgets/notification_widget-01.dart';
...
class _AllNotificationsPageState extends State<AllNotificationsPage> {
  ...
  Future<AllNotifications?> fetchAllNotifications(int page) async {
    ...
    var (success, internet, allNotifications) =
        await _propertyBloc.fetchAllNotifications(dataMap);
    if (mounted) {
      setState(() {
