...
class AddNewAgentPage extends StatefulWidget {
  ...
  const AddNewAgentPage(
      {Key? key, this.addNewAgentPageListener, this.agentDataForEdit})
      : super(key: key);
  ...
  void initState() {
    ...
    if (widget.agentDataForEdit != null) {
      addAgentInfoMap = {
        ...
        agencyUserId: widget.agentDataForEdit!.userAgentId,

        /// Basically agent user Id
              ...
              children: [
                Column(
                  ...
                  children: [
                    setValuesInFields(
                      labelText:
                          UtilityMethods.getLocalizedString("user_name") + " *",
                      hintText: UtilityMethods.getLocalizedString(
                          "enter_your_user_name"),
                      key: agentUserName,
                      initialValue: widget.agentDataForEdit != null
                          ? widget.agentDataForEdit!.agentUserName ?? ""
                          : "",
                      validate: true,
                      isFirst: true,
                    ...
                    setValuesInFields(
                      ...
                      initialValue: widget.agentDataForEdit != null
                          ? widget.agentDataForEdit!.agentFirstName ?? ""
                          : "",
                      key: agentFirstName,
                    ),
                    setValuesInFields(
                      ...
                      initialValue: widget.agentDataForEdit != null
                          ? widget.agentDataForEdit!.agentLastName ?? ""
                          : "",
                      key: agentLastName,
                    ),
                    setValuesInFields(
                    ...
                    setValuesInFields(
                        labelText:
                            UtilityMethods.getLocalizedString("password") +
                                " *",
                        hintText: UtilityMethods.getLocalizedString(
                            "enter_your_password"),
                        key: agentPassword,
                    ...
                    if (widget.agentDataForEdit == null)
                      _agentCityList != null && _agentCityList.isNotEmpty
                          ? dropDownWidget(
                              ...
                              agentCity)
                          : Container(),
                    if (widget.agentDataForEdit == null) sendEmailWidget(),
                    Container(
                      height: 50,
  ...
  void onSavedButtonPressed() async {
    if (formKey.currentState!.validate()) {
      ...
      if (widget.agentDataForEdit == null) {
        ...
        response =
            await _propertyBloc.fetchAddAgentResponse(addAgentInfoMap, nonce);
      } else {
        addAgentInfoMap.removeWhere(
            (String key, dynamic value) => value == null || value.isEmpty);
        response =
            await _propertyBloc.fetchEditAgentResponse(addAgentInfoMap, nonce);
      }
