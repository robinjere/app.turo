...
import 'package:turo_package/pages/add_property_pages/property_address.dart';
import 'package:turo_package/pages/add_property_pages/property_details.dart';
import 'package:turo_package/pages/add_property_pages/property_features.dart';
import 'package:turo_package/pages/add_property_pages/property_floorPlans.dart';
import 'package:turo_package/pages/add_property_pages/property_media.dart';
import 'package:turo_package/pages/add_property_pages/property_settings.dart';
import 'package:turo_package/pages/add_property_pages/property_contact_information.dart';
import 'package:turo_package/pages/add_property_pages/property_gdpr_agreement.dart';
import 'package:turo_package/pages/add_property_pages/property_information.dart';
import 'package:turo_package/pages/add_property_pages/property_private_note.dart';
import 'package:turo_package/pages/add_property_pages/property_sub_listing.dart';
import 'package:turo_package/pages/add_property_pages/property_virtual_tour_link.dart';
...
import 'package:turo_package/widgets/light_button_widget.dart';
...
class AddPropertyState extends State<AddProperty> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    if (widget.isDraftProperty) {
      ...
      if (widget.draftPropertyIndex != null &&
          widget.draftPropertyIndex != -1) {
        addPropertyDataMap[ADD_PROPERTY_DRAFT_INDEX] =
            widget.draftPropertyIndex;
      }
      if (addPropertyDataMap.containsKey(ADD_PROPERTY_DRAFT_PROGRESS_KEY)) {
        ...
        _draftPropertiesDataMapsList =
            HiveStorageManager.readDraftPropertiesDataMapsList() ?? [];

        /// For Updating Draft in storage
        if (widget.draftPropertyIndex != null) {
          _draftPropertiesDataMapsList[widget.draftPropertyIndex!] =
              addPropertyDataMap;
        } else {
    ...
    if (!widget.isPropertyForUpdate &&
      ...
      if (realtorIdStr.isNotEmpty &&
        ...
        if (realtorId != null) {
          addPropertyDataMap[ADD_PROPERTY_FAVE_AGENT_DISPLAY_OPTION] =
              AUTHOR_INFO;
    ...
    _propertyFeaturesMetaDataList =
        HiveStorageManager.readPropertyFeaturesMetaData() ?? [];
    ...
    _addPropertyPages = [
      ...
      PropertyFloorPlansPage(
        ...
        propertyInfoMap: addPropertyDataMap,
        isPropertyForUpdate: widget.isPropertyForUpdate,
        propertyFloorPlansPageListener:
            (List<Map<String, dynamic>> floorPlansList) {
          if (mounted)
            setState(() {
              ...
              if (tempPropertyFloorPlansPageList.isNotEmpty) {
                ...
                addPropertyDataMap[ADD_PROPERTY_FLOOR_PLANS] =
      ...
      PropertySubListingPage(
        formKey: formKey07,
        propertyInfoMap: addPropertyDataMap,
        propertySubListingPageListener:
            (List<Map<String, dynamic>> multiUnitsList,
                String selectedListingIDs) {
          if (mounted)
            setState(() {
              ...
              if (tempPropertyMultiUnitsPageList.isNotEmpty) {
                ...
                addPropertyDataMap[ADD_PROPERTY_FAVE_MULTI_UNITS] =
                    tempPropertyMultiUnitsPageList;
              }

              addPropertyDataMap[ADD_PROPERTY_FAVE_MULTI_UNITS_IDS] =
                  tempSelectedListingIDs;
            });
        },
      ),
        ...
        setState(() {
          _addPropertyPages.insert(
            ...
            PropertyContactInformationPage(
              formKey: formKey08,
              propertyInfoMap: addPropertyDataMap,
              propertyContactInformationPageListener:
                  (Map<String, dynamic> map) {
                tempPropertyContactInformationPageMap = map;
                addPropertyDataMap
                    .addAll(tempPropertyContactInformationPageMap);
              },
            ),
          );
        });
              ...
              propertyFeaturesPageListener: (Map<String, dynamic> map) {
                if (mounted)
                  setState(() {
                    ...
                    if (tempPropertyFeaturesPageMap
                        .containsKey(ADD_PROPERTY_FEATURES_LIST)) {
                      addPropertyDataMap[ADD_PROPERTY_FEATURES_LIST] =
                          tempPropertyFeaturesPageMap[
                              ADD_PROPERTY_FEATURES_LIST];
                    }
                  });
              },
            ),
    ...
    if (_draftPropertiesDataMapsList.isNotEmpty) {
      if (addPropertyDataMap.containsKey(ADD_PROPERTY_TITLE) &&
        ...
        if (widget.draftPropertyIndex == null) {
          ...
          if (draftItem[ADD_PROPERTY_TITLE] ==
              addPropertyDataMap[ADD_PROPERTY_TITLE]) {
  ...
  void onAppPause() {
    ...
    if (addPropertyDataMap.containsKey(ADD_PROPERTY_TITLE) &&
      ...
      addPropertyDataMap[ADD_PROPERTY_DRAFT_PROGRESS_KEY] =
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBarWidget(
          ...
          onBackPressed:
              SHOW_DRAFTS ? () => onBackPressedBottomSheet(context) : null,
                      ...
                      Expanded(
                        ...
                        child: LightButtonWidget(
                          ...
                          onPressed: () {
                            ...
                            Type _currentPageType =
                                _addPropertyPages[(_page - 1)].runtimeType;
                          ...
                          onPressed: () async {
                            ...
                            if (_currentPageType == PropertyInformationPage) {
                              ...
                              if (formKey05.currentState!.validate()) {
                                ...
                                PropertyContactInformationPage) {
                              if (formKey08.currentState != null &&
                            ...
                            if (_isPageValidated) {
                              if (_currentPageType ==
                                  _addPropertyPages.last.runtimeType) {
                                if (HooksConfigurations.addPropertyActionHook !=
                                    null) {
  ...
  startAddPropertyProcess() {
    ...
    if (mounted) {
      setState(() {
        addPropertyDataMap[ADD_PROPERTY_LOCAL_ID] =
    ...
    if (isLoggedIn == true) {
      ...
      if (mounted)
        setState(() {
          ...
          addPropertyDataMap[ADD_PROPERTY_UPLOAD_STATUS] =
              ADD_PROPERTY_UPLOAD_STATUS_PENDING;
        });
      ...
      _showToast(context,
          UtilityMethods.getLocalizedString("your_property_is_being_uploaded"));
      ...
      children: <Widget>[
        GenericBottomSheetTitleWidget(
          title: UtilityMethods.getLocalizedString(
              "draft_properties_exit_menu_title_text"),
          padding: const EdgeInsets.fromLTRB(10.0, 20.0, 10.0, 0.0),
        ),
        GenericBottomSheetSubTitleWidget(
          subTitle: UtilityMethods.getLocalizedString(
              "draft_properties_exit_menu_subtitle_text"),
          decoration: AppThemePreferences.dividerDecoration(),
          padding: const EdgeInsets.fromLTRB(10.0, 0.0, 10.0, 20.0),
        ),
        GenericBottomSheetOptionWidget(
          label: UtilityMethods.getLocalizedString(
              "draft_properties_exit_menu_option_save"),
          style: AppThemePreferences().appTheme.bottomSheetOptionsTextStyle!,
          onPressed: _onSaveDraftPressed,
        ),
        GenericBottomSheetOptionWidget(
          label: UtilityMethods.getLocalizedString(
              "draft_properties_exit_menu_option_discard"),
        ...
        GenericBottomSheetOptionWidget(
          label: UtilityMethods.getLocalizedString(
              "draft_properties_exit_menu_option_keep_editing"),
          style: AppThemePreferences()
              .appTheme
              .bottomSheetEmphasisOptionsTextStyle!,
  ...
  _onSaveDraftPressed() {
    ...
    addPropertyDataMap[ADD_PROPERTY_DRAFT_PROGRESS_KEY] =
        ADD_PROPERTY_DRAFT_SAVED;

    if (addPropertyDataMap[ADD_PROPERTY_TITLE] != null &&
        addPropertyDataMap[ADD_PROPERTY_TITLE].isNotEmpty) {
      _draftPropertiesDataMapsList =
          HiveStorageManager.readDraftPropertiesDataMapsList() ?? [];
      ...
      _showToast(
          ...
          UtilityMethods.getLocalizedString(
              "draft_properties_your_draft_is_saved"));
      ...
      _showToast(
          context,
          UtilityMethods.getLocalizedString(
              "draft_properties_toast_error_text"));
      Navigator.pop(context);
    }
  }
