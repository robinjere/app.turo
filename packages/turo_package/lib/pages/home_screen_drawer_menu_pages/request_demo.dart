...
class ContactDeveloperState extends State<ContactDeveloper>
  ...
  onSubmitPressed() async {
    if (formKey.currentState!.validate()) {
      ...
      final response =
          await _propertyBloc.fetchContactDeveloperResponse(dataMap);
      ...
      if (response == null || response.statusCode == null) {
        ...
        if (response.statusCode == 200) {
          _showToast(context,
              UtilityMethods.getLocalizedString("message_sent_successfully"));
          Navigator.pop(context);
        } else {
          _showToast(
            context,
            UtilityMethods.getLocalizedString("message_failed_to_send"),
          );
        }
      }
    }
