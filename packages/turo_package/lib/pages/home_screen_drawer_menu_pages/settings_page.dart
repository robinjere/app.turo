...
import 'package:turo_package/widgets/settings_page_widgets/demo_config_widget.dart';
import 'package:turo_package/widgets/settings_page_widgets/item_theme_design_widget.dart';
...
class HomePageSettingsState extends State<HomePageSettings> {
      ...
      for (var item in tempList) {
        if (item != null && item is Map && item.isNotEmpty) {
          if (item["sectionType"] == "preferences") {
            ...
            communityStandardsAndLegalPoliciesHookWidgetsList!
                .add(item["menuItem"]);
          } else {
      ...
      builder: (context, itemDesignNotifier, child) {
        return GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBarWidget(
              appBarTitle:
                  UtilityMethods.getLocalizedString("setting_and_privacy"),
            ),
                ...
                children: [
                  Column(
                    children: [
                      ...
                      if (hooksWidgetsList != null &&
                          hooksWidgetsList!.isNotEmpty)
                        Column(
  ...
  Widget loadingIndicatorWidget() {
    return _showLoadingWidget == false
        ? Container()
        : Positioned(
            left: 0,
            right: 0,
    ...
    return GenericSettingsWidget(
      ...
      body: Column(
        ...
        children: [
          ...
          if (preferencesHookWidgetsList != null &&
              preferencesHookWidgetsList!.isNotEmpty)
            Column(
  ...
  Widget communityStandardsAndLegalPoliciesWidget() {
    return GenericSettingsWidget(
      headingText: UtilityMethods.getLocalizedString(
          "community_standards_and_legal_policies"),
      removeDecoration: true,
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          if (communityStandardsAndLegalPoliciesHookWidgetsList != null &&
              communityStandardsAndLegalPoliciesHookWidgetsList!.isNotEmpty)
            Column(
