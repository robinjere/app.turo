...
class UserDisplayNameState extends State<UserDisplayName> with ValidationMixin {
  ...
  Future<void> _signOnMethod(Map<String, dynamic> userInfo) async {
    ...
    if (response == null || response.statusCode != 200) {
      ...
      oneSignalLoginFunc(response.data);
