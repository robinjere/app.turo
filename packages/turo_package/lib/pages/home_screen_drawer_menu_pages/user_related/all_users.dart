...
import 'package:turo_package/pages/home_screen_drawer_menu_pages/user_related/admin_user_signup.dart';
...
class _AllUsersState extends State<AllUsers> {
  ...
  Future<List<dynamic>> fetchUsers(int page, String search) async {
    ...
    List<dynamic> tempList =
        await _propertyBloc.fetchUsers(page, perPage, search);
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => AdminUserSignUp(
                          adminUserSignUpPageListener: (bool refresh) {
                        if (refresh) {
                          loadDataFromApi();
                        }
                      }),
                ...
                !showSearchDialog
                    ...
                    : ShowSearchDialog(
                        ...
                        searchDialogPageListener:
                          ...
                          loadDataFromApi(
                              search: searchMap![SEARCH_KEYWORD] ?? "");
                        },
                      ),
              ],
            ),
  ...
  Widget showUsersList(
      BuildContext context, Future<List<dynamic>> futureUsers) {
    return Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                userDetail.description != null &&
                                        userDetail.description!.isNotEmpty
                                    ? Padding(
                                        padding: EdgeInsets.fromLTRB(
