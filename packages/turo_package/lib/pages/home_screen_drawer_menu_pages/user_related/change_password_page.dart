...
class _ChangePasswordState extends State<ChangePassword> with ValidationMixin {
  ...
  fetchNonce() async {
    ApiResponse response =
        await _propertyBloc.fetchUpdatePasswordNonceResponse();
    if (response.success) {
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              ChangePasswordWaitingWidget(
                  showWaitingWidget: _showWaitingWidget),
              ChangePasswordBottomActionBarWidget(
    ...
    return ButtonWidget(
      ...
      onPressed: () async {
        if (formKey.currentState!.validate()) {
          ...
          final response = await _propertyBloc.fetchUpdateUserPasswordResponse(
              userInfo, nonce);
            ...
            if (response == null) {
              ...
              if (tempString.contains("{")) {
                ...
                if (map["success"] == true) {
                  ...
                  Map userInfoMapFromStorage =
                      HiveStorageManager.readUserCredentials();
                  Map<String, dynamic> userInfo = {
