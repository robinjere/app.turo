...
class _AllAgencyState extends State<AllAgency> {
  ...
  loadDataFromApi(bool forSearch, Map? agentSearchMap,
    ...
    if (forPullToRefresh) {
      ...
      page = 1;
      _futureAgenciesList =
          fetchAllAgenciesInfo(page, forSearch, agentSearchMap);
  ...
  Future<List<dynamic>> fetchAllAgenciesInfo(
      int page, bool forSearch, Map? searchMap) async {
          ...
          if (showSearchDialog)
            ShowSearchDialog(
              ...
              searchDialogPageListener:
                  (bool showDialog, Map<String, dynamic>? searchMap) {
  ...
  Widget buildAgenciesList(
      BuildContext context, Future<List<dynamic>> futureAgenciesList) {
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      RealtorNameWidget(
                                          title: item.title, tag: AGENCIES_TAG),
