...
import 'package:turo_package/widgets/saved_searches_widgets/ss_bottom_action_widget.dart';
import 'package:turo_package/widgets/saved_searches_widgets/ss_loading_widget.dart';
import 'package:turo_package/widgets/saved_searches_widgets/ss_no_result_found_widget.dart';
import 'package:turo_package/widgets/saved_searches_widgets/ss_pagination_loading_widget.dart';
import 'package:turo_package/widgets/saved_searches_widgets/ss_query_items_widget.dart';
import 'package:turo_package/widgets/saved_searches_widgets/ss_query_options_widget.dart';
...
class _SavedSearchesState extends State<SavedSearches>
    with AutomaticKeepAliveClientMixin<SavedSearches> {
    ...
    if (query.isNotEmpty) {
                ...
                if (_metaMap[metaKeyFiltersKey] is List &&
                  ...
                  for (Map metaQueryItem in _metaMapsList) {
                    ...
                    if (_value.isNotEmpty) {
                      ...
                      _value =
                          _value.replaceAll(" ", ""); // remove white-spaces
          ...
          case (keywordFiltersKey):
            {
              ...
              if (_decodedJson is Map) {
                ...
                if (_keywordFiltersMap[keywordFiltersKey] is List &&
                  ...
                  List<Map> _keywordFiltersMapsList =
                      List<Map>.from(_keywordFiltersMap[keywordFiltersKey]);

                  for (Map keywordFiltersQueryItem in _keywordFiltersMapsList) {
                    String _uniqueId =
                        keywordFiltersQueryItem[keywordFiltersUniqueIdKey];
                    _keywordFiltersQueryMap[_uniqueId] =
                        keywordFiltersQueryItem;
                  }
          ...
          default:
            {
              if (key.isNotEmpty &&
                  ...
                  key != "per_page") {
                value =
                    UtilityMethods.cleanContent(value, decodeComponent: true);
                queryMap[key] = value;
              }
            }
        }
      ...
      if (typeSlugList.isNotEmpty) {
        ...
        for (int i = 0; i < typeSlugList.length; i++) {
          ...
          queryTypeList.add(typeSlugList[i]);
        }
        ...
        if (_selectedTitleList.isNotEmpty &&
            _selectedTitleSlugList.isNotEmpty) {
        ...
        if (queryMap[PROPERTY_TYPE] != null &&
            queryMap[PROPERTY_TYPE].isNotEmpty) {
  ...
  String getStatusName(String status) {
    int itemIndex =
        propertyStatusMetaData.indexWhere((element) => element.slug == status);
    if (itemIndex != -1) {
