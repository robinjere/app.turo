...
import 'package:turo_package/pages/home_screen_drawer_menu_pages/add_agent.dart';
...
class MyAgencyAgents extends StatefulWidget {
  ...
  const MyAgencyAgents({Key? key, this.fromBottomNavigator = false})
      : super(key: key);
...
class _MyAgencyAgentsState extends State<MyAgencyAgents> {
  ...
  Future<List<dynamic>> fetchAgentsInfo(bool refreshing) async {
    ...
    List<dynamic> tempList =
        await _propertyBloc.fetchAgencyAllAgentList(userId!);
  ...
  Widget _horizontalListForAgents(
      BuildContext context, Future<List<dynamic>> agentsAndAgenciesInfoList) {
        ...
        builder: (context, articleSnapshot) {
          if (articleSnapshot.hasData) {
            ...
            if (tempList.isNotEmpty &&
                tempList != null &&
                tempList.isNotEmpty) {
              List<dynamic> _agentOrAgencyInfoList =
                  tempList; //[0].map((e) => e).toList();
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: GenericTextWidget(
                                          ...
                                          style: AppThemePreferences()
                                              .appTheme
                                              .homeScreenRealtorInfoTextStyle,
                                        ),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.fromLTRB(
                ...
                builder: (BuildContext context) => AlertDialogWidget(
                  ...
                  actions: <Widget>[
                    ...
                    TextButtonWidget(
                      onPressed: () async {
                        final response =
                            await _propertyBloc.fetchDeleteAgentResponse(
