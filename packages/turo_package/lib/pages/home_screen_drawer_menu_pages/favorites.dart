...
import 'package:turo_package/widgets/article_box_widgets/article_box_design_for_favourites.dart';
...
class _FavoritesState extends State<Favorites>
  ...
  Future<List<dynamic>> fetchFavProperties(int page, String userIdStr) async {
    ...
    List<dynamic> tempList =
        await _propertyBloc.fetchFavProperties(page, perPage, userIdStr);
    if (tempList == null ||
  ...
  Widget showFavoritesList(
      BuildContext context, Future<List<dynamic>>? futureFavProperties) {
              ...
              footer: CustomFooter(
                builder: (BuildContext context, LoadStatus? mode) {
                  ...
                  if (mode == LoadStatus.loading) {
                    if (shouldLoadMore) {
                      body = SizedBox(
                          height: 55.0, child: paginationLoadingWidget());
                    } else {
                      body = Container();
                    }
                  }
                    ...
                    return FavouritesArticleBoxDesign(
                        ...
                        favouritesArticleBoxDesignWidgetListener:
                          ...
                          removeFromFavoritesList(
                              propertyListIndex, addOrRemoveFromFavInfo);
                        });
                  }));
        ...
        child: Column(
          children: [
            if (!isInternetConnected)
              NoInternetBottomActionBarWidget(onPressed: () => retryLoadData()),
          ],
        ),
      ),
    );
  ...
  Future<void> removeFromFavoritesList(int propertyListIndex,
      Map<String, dynamic> addOrRemoveFromFavInfo) async {
