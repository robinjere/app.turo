...
typedef PropertyVirtualTourLinkPageListener = void Function(
    Map<String, dynamic> _dataMap);

class PropertyVirtualTourLinkPage extends StatefulWidget {
  final PropertyVirtualTourLinkPageListener?
      propertyVirtualTourLinkPageListener;
...
class PropertyVirtualTourLinkPageState
    extends State<PropertyVirtualTourLinkPage> {
  ...
  void initState() {
    ...
    if (tempMap != null) {
      if (tempMap.containsKey(ADD_PROPERTY_VIRTUAL_TOUR)) {
        _virtualTourLinkTextController.text =
            tempMap[ADD_PROPERTY_VIRTUAL_TOUR];
      }
    }
    super.initState();
  }
    ...
    return Container(
      ...
      child: TextFormFieldWidget(
        hintText: UtilityMethods.getLocalizedString(
            "enter_virtual_tour_iframe_embedded_code"),
