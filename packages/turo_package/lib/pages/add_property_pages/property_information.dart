...
typedef PropertyInformationPageListener = void Function(
...
class PropertyInformationPageState extends State<PropertyInformationPage>
  ...
  void initState() {
    ...
    if (tempMap != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_DESCRIPTION)) {
        _propertyDescriptionTextController.text =
            tempMap[ADD_PROPERTY_DESCRIPTION] ?? "";
      }
      ...
      if (tempMap.containsKey(ADD_PROPERTY_PRICE_PREFIX)) {
        _propertyPricePrefixTextController.text =
            tempMap[ADD_PROPERTY_PRICE_PREFIX] ?? "";
      }
      if (tempMap.containsKey(ADD_PROPERTY_PRICE_POSTFIX)) {
        _propertyPricePostfixTextController.text =
            tempMap[ADD_PROPERTY_PRICE_POSTFIX] ?? "";
      }
      if (tempMap.containsKey(ADD_PROPERTY_SECOND_PRICE)) {
        _propertySecondPriceTextController.text =
            tempMap[ADD_PROPERTY_SECOND_PRICE] ?? "";
      }
      ...
      if (tempMap.containsKey(ADD_PROPERTY_TYPE) &&
          tempMap[ADD_PROPERTY_TYPE] != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_LABEL_NAMES_LIST) &&
          tempMap[ADD_PROPERTY_LABEL_NAMES_LIST] != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_LABELS) &&
          tempMap[ADD_PROPERTY_LABELS] != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_STATUS_NAMES_LIST) &&
          tempMap[ADD_PROPERTY_STATUS_NAMES_LIST] != null) {
        if (tempMap[ADD_PROPERTY_STATUS_NAMES_LIST] is List) {
          ...
          _selectedPropertyStatusList = [
            tempMap[ADD_PROPERTY_STATUS_NAMES_LIST]
          ];
        }
      }
      if (tempMap.containsKey(ADD_PROPERTY_STATUS) &&
          tempMap[ADD_PROPERTY_STATUS] != null) {
  ...
  Widget aboutPropertyTextWidget() {
    return headingWidget(
        text: UtilityMethods.getLocalizedString("description"));
  }
  ...
  Widget addPricePrefix() {
    return TextFormFieldWidget(
      ...
      additionalHintText:
          UtilityMethods.getLocalizedString("for_example_start_from"),
  ...
  Widget addAfterThePrice() {
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        additionalHintText:
            UtilityMethods.getLocalizedString("for_example_monthly"),
