...
import 'package:turo_package/models/dynamic_item.dart';
import 'package:turo_package/widgets/add_property_widgets/additional_details_widget.dart';
...
typedef PropertyDetailsPageListener = void Function(
  ...
  void initState() {
    ...
    if (tempMap != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_SIZE_PREFIX)) {
        _sizePostfixTextController.text =
            tempMap[ADD_PROPERTY_SIZE_PREFIX] ?? "";
      }
      ...
      if (tempMap.containsKey(ADD_PROPERTY_LAND_AREA_PREFIX)) {
        _landAreaSizePostfixTextController.text =
            tempMap[ADD_PROPERTY_LAND_AREA_PREFIX] ?? "";
      }
      ...
      if (tempMap.containsKey(ADD_PROPERTY_GARAGE_SIZE)) {
        _garageSizeTextController.text =
            tempMap[ADD_PROPERTY_GARAGE_SIZE] ?? "";
      }
      if (tempMap.containsKey(ADD_PROPERTY_PROPERTY_ID)) {
        _propertyIDTextController.text =
            tempMap[ADD_PROPERTY_PROPERTY_ID] ?? "";
      }
                  ...
                  children: [
                    ...
                    GenericAdditionalDetailsWidget(
                      ...
                      listener: (updatedItemsList) {
                        ...
                        dataMap[ADD_PROPERTY_ADDITIONAL_FEATURES] =
                            dataHolderList;
                        widget.propertyDetailsPageListener!(dataMap);
                      },
                    ),
  ...
  Widget addSizePostfix() {
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        additionalHintText: UtilityMethods.getLocalizedString("for_example") +
    ...
    return Container(
      ...
      child: TextFormFieldWidget(
        labelText: UtilityMethods.getLocalizedString(
            "size_postfix"), //AppLocalizations.of(context).size_postfix,
        hintText: UtilityMethods.getLocalizedString(
            "enter_size_postfix"), //AppLocalizations.of(context).enter_size_postfix,
        additionalHintText: UtilityMethods.getLocalizedString("for_example") +
            MEASUREMENT_UNIT_TEXT, //AppLocalizations.of(context).for_example_Sq_Ft,
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: formFieldDecoration(
                  hintText:
                      UtilityMethods.getLocalizedString("enter_property_id")),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(top: 5, left: 5),
            child: hintWidget(
                UtilityMethods.getLocalizedString("for_example_hz_01")),
          ),
        ],
      ),
    );
