...
typedef PropertyPrivateNotePageListener = void Function(
...
class PropertyPrivateNotePageState extends State<PropertyPrivateNotePage> {
  ...
  final TextEditingController _privateNoteTextController =
  ...
  void initState() {
    ...
    if (tempMap != null && tempMap.isNotEmpty) {
      if (tempMap.containsKey(ADD_PROPERTY_PRIVATE_NOTE)) {
        _privateNoteTextController.text =
            tempMap[ADD_PROPERTY_PRIVATE_NOTE] ?? "";
      }
    }
  }
    ...
    return Container(
      ...
      child: TextFormFieldWidget(
        labelText: UtilityMethods.getLocalizedString(
            "write_private_note_for_this_property_it_will_not_display_for_public"),
