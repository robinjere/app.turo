...
import 'package:turo_package/widgets/add_property_widgets/floor_plan_widget.dart';
...
typedef PropertyFloorPlansPageListener = void Function(
    ...
    if (widget.propertyInfoMap != null && widget.propertyInfoMap!.isNotEmpty) {
      if (widget.propertyInfoMap!.containsKey(ADD_PROPERTY_FLOOR_PLANS) &&
        ...
        List<Map<String, dynamic>>? list =
            widget.propertyInfoMap![ADD_PROPERTY_FLOOR_PLANS];
        if (list != null && list.isNotEmpty) {
          for (int i = 0; i < list.length; i++) {
            var item = list[i];
            if (widget.isPropertyForUpdate != null &&
                widget.isPropertyForUpdate!) {
