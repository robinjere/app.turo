...
import 'package:turo_package/widgets/add_property_widgets/contact_info_widget.dart';
...
class PropertyContactInformationPage extends StatefulWidget {
  ...
  @override
  State<PropertyContactInformationPage> createState() =>
      _PropertyContactInformationPageState();
}

class _PropertyContactInformationPageState
    extends State<PropertyContactInformationPage> {
                      ...
                      ContactInformationWidget(
                        ...
                        listener: ({showWaitingWidget, updatedDataMap}) {
                          ...
                          if (updatedDataMap != null) {
                            widget.propertyContactInformationPageListener!(
                                updatedDataMap);
                          }
                        },
                      ),
