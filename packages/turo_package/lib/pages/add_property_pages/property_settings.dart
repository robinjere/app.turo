...
import 'package:turo_package/models/radio_item.dart';
...
import 'package:turo_package/widgets/radio_button_widget.dart';

typedef PropertySettingsPageListener = void Function(
...
class PropertySettingsPageState extends State<PropertySettingsPage> {
  ...
  final TextEditingController _propertyDisclaimerTextController =
  ...
  void initState() {
    ...
    if (tempMap != null) {
      ...
      if (tempMap.containsKey(ADD_PROPERTY_DISCLAIMER)) {
        _propertyDisclaimerTextController.text =
            tempMap[ADD_PROPERTY_DISCLAIMER] ?? "";
      }
    }

    userLoginSelectedOption ??= userLoginOptionsList[0].value;
    makePropertyFeaturedSelectedOption ??=
        makePropertyFeaturedOptionsList[0].value;
                  ...
                  children: [
                    ...
                    RadioButtonWidget(
                      ...
                      listener: (value) {
                        ...
                        dataMap[ADD_PROPERTY_LOGGED_IN_REQUIRED] =
                            userLoginSelectedOption;
                        widget.propertySettingsPageListener!(dataMap);
                      },
                    ),
                    addDisclaimer(),
