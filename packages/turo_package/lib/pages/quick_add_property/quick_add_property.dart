...
import 'package:turo_package/widgets/custom_widgets/card_widget.dart';
...
import 'package:turo_package/widgets/filter_page_widgets/term_picker_related/term_picker_multi_select_dialog.dart';
import 'package:turo_package/widgets/generic_link_widget.dart';
import 'package:turo_package/widgets/generic_text_field_widgets/generic_add_room_widget.dart';
...
typedef DropDownViewWidgetListener = void Function(
    List<dynamic>? listOfSelectedItems, List<dynamic>? listOfSelectedIdsSlugs);
...
class _QuickAddPropertyState extends State<QuickAddProperty> {
  ...
  void dispose() {
    ...
    if (_propertyPropertyTypeTextController != null)
      _propertyPropertyTypeTextController.dispose();
    if (_propertyPropertyStatusTextController != null)
      _propertyPropertyStatusTextController.dispose();
    if (_propertyPropertyLabelTextController != null)
  ...
  void initState() {
    ...
    _propertyLabelMetaDataList =
        HiveStorageManager.readPropertyLabelsMetaData();
    _propertyStatusMetaDataList =
  ...
  Widget addPropertyTitle(BuildContext context) {
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        hintText:
            UtilityMethods.getLocalizedString("enter_your_property_title"),
        keyboardType: TextInputType.text,
        validator: (String? value) {
          if (value?.isEmpty ?? true) {
            return UtilityMethods.getLocalizedString(
                "property_title_cannot_be_empty");
          }
          return null;
        },
        onSaved: (value) {
    ...
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        validator: (String? value) {
          if (value?.isEmpty ?? true) {
            return UtilityMethods.getLocalizedString(
                "property_description_cannot_be_empty");
          }
          return null;
        },
        onSaved: (value) {
                  ...
                  builder: (BuildContext context) {
                    return MultiSelectDialogWidget(
                      ...
                      multiSelectDialogWidgetListener:
                        ...
                        dropDownViewWidgetListener!(
                            _selectedItemsList, _listOfSelectedItemsIds);
                      },
                    );
                  },
                );
  ...
  Widget addType(BuildContext context) {
    return _propertyTypeMetaDataList == null ||
            _propertyTypeMetaDataList.isEmpty
        ? Container()
        : dropDownViewWidget(
            context: context,
            ...
            validator: (String? value) {
              if (value != null && value.isNotEmpty) {
                if (mounted) {
                  setState(() {
                    addPropertyDataMap[ADD_PROPERTY_TYPE_NAMES_LIST] =
                        _selectedPropertyTypeList;
                    addPropertyDataMap[ADD_PROPERTY_TYPE] =
                        _selectedPropertyTypeIdsList;
                  });
                }
              }
              // else{
                ...
                setState(() {
                  ...
                  _propertyPropertyTypeTextController.text =
                      getMultiSelectFieldValue(
                          context, _selectedPropertyTypeList)!;
                });
              }
            });
  }
  ...
  Widget addStatus(BuildContext context) {
    return _propertyStatusMetaDataList == null ||
            _propertyStatusMetaDataList.isEmpty
        ? Container()
        : dropDownViewWidget(
            context: context,
            ...
            validator: (String? value) {
              if (value != null && value.isNotEmpty) {
                if (mounted) {
                  setState(() {
                    addPropertyDataMap[ADD_PROPERTY_STATUS_NAMES_LIST] =
                        _selectedPropertyStatusList;
                    addPropertyDataMap[ADD_PROPERTY_STATUS] =
              ...
              if (mounted) {
                setState(() {
                  ...
                  _propertyPropertyStatusTextController.text =
                      getMultiSelectFieldValue(
                          context, _selectedPropertyStatusList)!;
                });
              }
            });
  }
  ...
  Widget addLabel(BuildContext context) {
    return _propertyLabelMetaDataList == null ||
            _propertyLabelMetaDataList.isEmpty
        ? Container()
        : dropDownViewWidget(
            context: context,
            ...
            validator: (String? value) {
              if (value != null && value.isNotEmpty) {
                if (mounted) {
                  setState(() {
                    addPropertyDataMap[ADD_PROPERTY_LABEL_NAMES_LIST] =
                        _selectedPropertyLabelList;
                    addPropertyDataMap[ADD_PROPERTY_LABELS] =
              ...
              if (mounted) {
                setState(() {
                  ...
                  _propertyPropertyLabelTextController.text =
                      getMultiSelectFieldValue(
                          context, _selectedPropertyLabelList)!;
                });
              }
            });
  }
    ...
    return Container(
      ...
      child: TextFormFieldWidget(
        labelText: UtilityMethods.getLocalizedString("address") +
            " *", //AppLocalizations.of(context).address_star,
        hintText: UtilityMethods.getLocalizedString(
            "enter_your_property_address"), //AppLocalizations.of(context).enter_your_property_address,
        validator: (String? value) {
          if (value?.isEmpty ?? true) {
            return UtilityMethods.getLocalizedString(
  ...
  Widget addSizePostfix(BuildContext context) {
    return Container(
      ...
      child: TextFormFieldWidget(
        ...
        additionalHintText:
            UtilityMethods.getLocalizedString("for_example_Sq_Ft"),
        onChanged: (value) {
          setState(() {
            _sizePostfix = value!;
          });
        ...
        children: [
          ...
          Padding(
            ...
            child: GenericTextWidget(
              "$_totalImages" +
                  UtilityMethods.getLocalizedString("fifty_files"),
              ...
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: Image.file(
                    ...
                    height:
                        AppThemePreferences.propertyMediaGridViewImageHeight,
                  ),
                ),
              ),
              Positioned(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: GenericLinkWidget(
                      preLinkText: UtilityMethods.getLocalizedString(
                          "i_consent_to_having_this_website_to_store_my_submitted_information_read_more_information"),
                      linkText:
                          UtilityMethods.getLocalizedString("gdpr_agreement"),
                      onLinkPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (isLoggedIn == true) {
        ...
        _showToast(
            context,
            UtilityMethods.getLocalizedString(
                "your_property_is_being_uploaded"));
