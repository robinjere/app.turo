                ...
                Column(
                  ...
                  children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          setValuesInFields(
                              ...
                              initialValue: widget.forEditLead
                                  ? widget.leads?.firstName
                                  : name,
                              validate: true),
                          setValuesInFields(
                              labelText: UtilityMethods.getLocalizedString(
                    ...
                    CardWidget(
                      ...
                      child: Column(
                        children: [
                          ...
                          setValuesInFields(
                              labelText:
                                  UtilityMethods.getLocalizedString("facebook"),
                              hintText: UtilityMethods.getLocalizedString(
                                  "enter_facebook_profile_url"),
                              key: addLeadFacebook,
                              initialValue: widget.leads?.facebookUrl,
                              isFirst: true),
                          setValuesInFields(
                            labelText:
                                UtilityMethods.getLocalizedString("twitter"),
                            hintText: UtilityMethods.getLocalizedString(
                                "enter_twitter_profile_url"),
                            key: addLeadTwitter,
                            initialValue: widget.leads?.twitterUrl,
                          ),
                          setValuesInFields(
                            labelText:
                                UtilityMethods.getLocalizedString("linkedIn"),
                            hintText: UtilityMethods.getLocalizedString(
                                "enter_linkedIn_profile_url"),
                            key: addLeadLinkedIn,
                    ...
                    CardWidget(
                      ...
                      child: Column(
                        children: [
                          headerTextWidget(UtilityMethods.getLocalizedString(
                              "private_note")),
                          setValuesInFields(
                            labelText: UtilityMethods.getLocalizedString(
                                "private_note"),
      ...
      child: ButtonWidget(
        ...
        onPressed: () async {
          if (formKey.currentState!.validate()) {
            ...
            addLeadInfoMap[addLeadName] =
                "${addLeadInfoMap[addLeadFirstName]} ${addLeadInfoMap[addLeadLastName]}";
            ...
            final response =
                await _crmRepository.fetchAddLeadResponse(addLeadInfoMap);
