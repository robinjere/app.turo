...
import 'package:turo_package/pages/crm_pages/crm_leads/add_new_lead_page.dart';
...
import 'package:turo_package/pages/crm_pages/crm_pages_widgets/crm_details_listing_page.dart';
import 'package:turo_package/pages/crm_pages/crm_pages_widgets/crm_notes_listings.dart';
...
class _LeadDetailPageState extends State<LeadDetailPage> {
  ...
  initializePage() {
    pageList = [
      ...
      SavedSearches(
          leadId: leadDetail!.leadLeadId!, fetchLeadSavedSearches: true),
  ...
  Future<List<dynamic>> fetchLeadDetail() async {
    List tempList = [];
    tempList = await _crmRepository.fetchLeadsInquiriesFromBoard(
        widget.idForFetchLead!, 1,
              ...
              onTap: () {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  if (UtilityMethods.validateURL(leadDetail!.sourceLink!)) {
                    ...
                    } else if (leadDetail!.source! == "agent" ||
                        leadDetail!.source! == "agency") {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  onPressed: () async {
                    ...
                    if (leadID != null) {
                      ...
                      if (response.statusCode == 200) {
                        ...
                        _showToast(context,
                            UtilityMethods.getLocalizedString("lead_deleted"));
                      } else {
                        Navigator.pop(context);
                        _showToast(
                          context,
