...
class _LeadsFromBoardState extends State<LeadsFromBoard> {
  ...
  Future<List<dynamic>> fetchLeadsFromBoard(int page) async {
    ...
    List<dynamic> tempList =
        await _crmRepository.fetchLeadsFromBoard(page, perPage);
    if (tempList == null ||
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AddNewLeadPage(addNewLeadPageListener: (bool refresh) {
                    if (refresh) {
                      loadDataFromApi();
                    }
                  }),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CRMContactDetail(
                                lead.displayName, lead.email, lead.mobile, () {
