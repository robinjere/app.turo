...
const String HOUZEZ_ACTIVITIES_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/activities";
// const String HOUZEZ_INQUIRIES_FROM_BOARD_PATH = "/wp-json/houzez-mobile-api/v1/enquiries";
const String HOUZEZ_INQUIRIES_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/all-enquiries";
const String HOUZEZ_INQUIRY_MATCHED_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/enquiry-matched-listing";
const String HOUZEZ_LEAD_INQUIRIES_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/lead-details";
const String HOUZEZ_LEAD_VIEWED_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/lead-listing-viewed";
const String HOUZEZ_INQUIRY_NOTES_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/enquiry-notes";
const String HOUZEZ_LEADS_NOTES_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/lead-notes";
...
const String HOUZEZ_DEALS_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/deals";
const String HOUZEZ_LEADS_FROM_BOARD_PATH =
    "/wp-json/houzez-mobile-api/v1/leads";
const String HOUZEZ_ADD_DEALS_PATH = "/wp-json/houzez-mobile-api/v1/add-deal";
const String HOUZEZ_DELETE_DEALS_PATH =
    "/wp-json/houzez-mobile-api/v1/delete-deal";
const String HOUZEZ_ADD_INQUIRY_PATH =
    "/wp-json/houzez-mobile-api/v1/add-crm-enquiry";
const String HOUZEZ_ADD_CRM_NOTES_PATH =
    "/wp-json/houzez-mobile-api/v1/add-note";
const String HOUZEZ_SEND_CRM_EMAIL_PATH =
    "/wp-json/houzez-mobile-api/v1/send-matched-listing-email";
const String HOUZEZ_DELETE_INQUIRY_PATH =
    "/wp-json/houzez-mobile-api/v1/delete-crm-enquiry";
const String HOUZEZ_DELETE_CRM_NOTES_PATH =
    "/wp-json/houzez-mobile-api/v1/delete-note";
const String HOUZEZ_DELETE_LEADS_PATH =
    "/wp-json/houzez-mobile-api/v1/delete-lead";
...
const String HOUZEZ_UPDATE_DEAL_DETAIL_PATH =
    "/wp-json/houzez-mobile-api/v1/update-deal-data";
...
class CRMHOUZEZApiProvider implements CRMApiProviderInterface {
  ...
  ApiRequest provideDeleteDealApi(int id, String nonce, String nonceVariable) {
    var params = {'deal_id': "$id", nonceVariable: nonce};
  ...
  ApiRequest provideDeleteLeadApi(id, String nonce, String nonceVariable) {
    var params = {'lead_id': "$id", nonceVariable: nonce};
