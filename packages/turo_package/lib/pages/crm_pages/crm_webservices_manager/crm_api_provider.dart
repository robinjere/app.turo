...
class CRMApiProvider {
  ...
  refreshToken() async {
    ...
    if (userInfoMapFromStorage != null && userInfoMapFromStorage.isNotEmpty) {
      Map<String, dynamic> userInfo = userInfoMapFromStorage
  ...
  Future<Response> fetchActivitiesFromBoardResponse(
      int page, int perPage, int userId,
      {Map<String, dynamic>? options}) async {
    var uri = _crmApiProviderInterface.provideActivitiesFromBoardApi(
        page, perPage, userId);
    return doRequestOnRoute(uri, tag: "CRM activities");
  }

  Future<Response> fetchInquiriesFromBoardResponse(
      int page, int perPage) async {
    var uri =
        _crmApiProviderInterface.provideInquiriesFromBoardApi(page, perPage);
    return doRequestOnRoute(uri, tag: "CRM inquiries");
  }

  Future<Response> fetchInquiryDetailMatchedFromBoardResponse(
      String enquiryId, int propPage) async {
    var uri = _crmApiProviderInterface.provideInquiryDetailMatchedFromBoardApi(
        enquiryId, propPage);
    return doRequestOnRoute(uri, tag: "CRM inquiry matched");
  }

  Future<Response> fetchLeadsInquiriesFromBoardResponse(
      String leadId, int propPage) async {
    var uri = _crmApiProviderInterface.provideLeadsInquiriesFromBoardApi(
        leadId, propPage);
    return doRequestOnRoute(uri, tag: "CRM lead inquiries");
  }

  Future<Response> fetchLeadsViewedFromBoardResponse(
      String leadId, int propPage) async {
    var uri = _crmApiProviderInterface.provideLeadsViewedFromBoardApi(
        leadId, propPage);
    return doRequestOnRoute(uri, tag: "CRM lead viewed");
  }

  Future<Response> fetchInquiryDetailNotesFromBoardResponse(
      String enquiryId) async {
    var uri = _crmApiProviderInterface
        .provideInquiryDetailNotesFromBoardApi(enquiryId);
  ...
  Future<Response> fetchLeadsDetailNotesFromBoardResponse(String leadId) async {
    var uri =
        _crmApiProviderInterface.provideLeadsDetailNotesFromBoardApi(leadId);
    return doRequestOnRoute(uri, tag: "CRM leads notes");
  }

  Future<Response> fetchLeadsFromActivityResponse(int page, int userId,
      {Map<String, dynamic>? options}) async {
    var uri =
        _crmApiProviderInterface.provideLeadsFromActivityApi(page, userId);
    return doRequestOnRoute(uri, tag: "CRM leads");
  }

  Future<Response> fetchDealsFromActivityResponse(int page, int userId,
      {Map<String, dynamic>? options}) async {
    var uri =
        _crmApiProviderInterface.provideDealsFromActivityApi(page, userId);
    return doRequestOnRoute(uri, tag: "CRM activity deals");
  }

  Future<Response> fetchDealsFromBoardResponse(
      int page, int perPage, String tab,
      {Map<String, dynamic>? options}) async {
    var uri =
        _crmApiProviderInterface.provideDealsFromBoardApi(page, perPage, tab);
  ...
  Future<Response> fetchAddDealResponse(Map<String, dynamic> dataMap) async {
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "CRM add deal", handle500: true);
  }

  Future<Response> fetchLeadsFromBoard(int page, int perPage,
      {Map<String, dynamic>? options}) async {
  ...
  Future<Response> fetchDeleteDeal(int id, String nonce) async {
    ApiRequest request = _crmApiProviderInterface.provideDeleteDealApi(
        id, nonce, kDealDeleteNonceVariable);
    return doRequestOnRoute(request.uri,
        type: POST, dataMap: request.params, tag: "CRM delete deals");
  }
  ...
  Future<Response> fetchAddInquiryResponse(Map<String, dynamic> dataMap) async {
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "CRM add inquiry", handle500: true);
  }

  Future<Response> fetchAddCRMNotesResponse(
  ...
  Future<Response> fetchSendCRMEmailResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _crmApiProviderInterface.provideSendCRMEmailApi();
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "send crm email", handle500: true);
  }

  Future<Response> fetchDeleteCRMNotesResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _crmApiProviderInterface.provideDeleteCRMNotesApi();
    return doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "delete Delete CRM Notes",
        handle500: true);
  }
  ...
  Future<Response> fetchDeleteInquiry(int id) async {
    ...
    return doRequestOnRoute(request.uri,
        type: POST, dataMap: request.params, tag: "CRM delete inquiry");
  }
  ...
  Future<Response> fetchAddLeadResponse(Map<String, dynamic> dataMap) async {
    ...
    return doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "CRM add lead", handle500: true);
  }

  Future<Response> fetchUpdateDealDetailResponse(
      Map<String, dynamic> dataMap) async {
    var uri = _crmApiProviderInterface.provideUpdateDealDetailResponseApi();
    return doRequestOnRoute(uri,
        type: POST,
        dataMap: dataMap,
        tag: "CRM update deal detail",
        handle500: true);
  }
  ...
  Future<Response> fetchDeleteLead(int id, String nonce) async {
    ApiRequest request = _crmApiProviderInterface.provideDeleteLeadApi(
        id, nonce, kLeadDeleteNonceVariable);
    return doRequestOnRoute(request.uri,
        type: POST, dataMap: request.params, tag: "delete lead");
  }
  ...
  Future<ApiResponse> createNonce(String nonceName) async {
    ...
    Response response = await doRequestOnRoute(uri,
        type: POST, dataMap: dataMap, tag: "Create Nonce", handle403: false);
    ApiResponse<String> nonce = PropertyApiProvider(HOUZEZApiProvider())
        .getCurrentParser()
        .parseNonceResponse(response);
    return nonce;
  }
}
