...
class _AddNewDealState extends State<AddNewDeal> with ValidationMixin {
  ...
  loadData() {
    ...
    _futureLeadsFromBoard!.then((value) {
      if (value != null && value.isNotEmpty) {
        ...
        if (widget.forEditDeal) {
          var contactInfo = contactList.firstWhere((element) =>
              element["id"] == widget.dealDetailMap[DEAL_CONTACT_NAME_ID]);
  ...
  Future<List<dynamic>> fetchLeadsFromBoard(
      int page, int perPage, int userId) async {
    List tempList = [];
    do {
                        ...
                        children: [
                          ...
                          setValuesInFields(
                              ...
                              UtilityMethods.getLocalizedString(
                                  "enter_the_deal_title"),
                              DEAL_TITLE,
                              TextInputType.text,
                              widget.dealDetailMap.isEmpty
                                  ? ""
                          ...
                          setValuesInFields(
                              UtilityMethods.getLocalizedString("deal_value") +
                                  " *",
                              UtilityMethods.getLocalizedString(
                                  "enter_the_deal_value"),
                              DEAL_VALUE,
                              TextInputType.number,
                              widget.dealDetailMap.isEmpty
                                  ? ""
                                  : widget.dealDetailMap[DEAL_DETAIL_VALUE]),
                          Container(
  ...
  Widget dropDownGroup() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          GenericTextWidget(UtilityMethods.getLocalizedString("group") + " *",
                    ...
                    return MapEntry(
                        ...
                        DropdownMenuItem<String>(
                          ...
                          child: GenericTextWidget(
                              UtilityMethods.getLocalizedString(description)),
                        ));
                  })
                  .values
                  .toList(),
            ...
            child: DropdownButtonFormField(
              ...
              items: contactList.map((map) {
                return DropdownMenuItem(
                  child: GenericTextWidget(UtilityMethods.getLocalizedString(
                      map['displayName'] ?? "")),
                  value: map['id'],
                );
              }).toList(),
    ...
    return agentsInfoList == null || agentsInfoList.isEmpty
        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                GenericTextWidget(
                    UtilityMethods.getLocalizedString("agent") +
    ...
    return ButtonWidget(
        ...
        onPressed: () async {
          if (formKey.currentState!.validate()) {
            ...
            final response =
                await _crmRepository.fetchAddDealResponse(addDealInfoMap);
            ...
            if (map["success"] == true) {
              ...
              widget.addNewDealPageListenerPageListener!(
                  true, addDealInfoMap[DEAL_GROUP]);
