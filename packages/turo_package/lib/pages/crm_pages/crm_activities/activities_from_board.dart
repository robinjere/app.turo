...
import 'package:turo_package/pages/crm_pages/crm_leads/lead_detail_page.dart';
...
class _ActivitiesFromBoardState extends State<ActivitiesFromBoard> {
      ...
      if (value != null && value.isNotEmpty) {
        if (mounted) {
          setState(() {
            ...
            CRMDealsAndLeadsFromActivity dealsAndLeadsFromActivity =
  ...
  Future<List<dynamic>> fetchDealsAndLeadsFromActivity() async {
    List<dynamic> tempList =
        await _crmRepository.fetchDealsAndLeadsFromActivity();
                ...
                children: [
                  ...
                  Container(
                    child: showActivitiesList(
                        context, _futureActivitiesFromBoard!),
                  ),
                ],
              ),
            ),
          ),
          if (_refreshController.isLoading) const CRMPaginationLoadingWidget(),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        setLeadDataWidget(
                            percentDay, posOrNegDay!, "last_24_hours", lastDay),
                        const Divider(),
                        setLeadDataWidget(percentWeek, posOrNegWeek!,
                            "last_7_days", lastWeek),
                        const Divider(),
                        setLeadDataWidget(percentMonth, posOrNegMonth!,
  ...
  Widget setLabelWidget(String label) {
    return Row(
      ...
      children: [
        Padding(
          padding:
              const EdgeInsets.only(left: 10, top: 3, right: 0, bottom: 10),
  ...
  Widget showActivitiesList(
      BuildContext context, Future<List<dynamic>> futureActivitiesFromBoard) {
                        ...
                        onTap: () {
                          if (activity.type == kReview) {
                            navigateToPage((context) => AllReviews(
                                  ...
                                  fromProperty:
                                      activity.reviewPostType == "property"
                                          ? true
                                          : false,
                            ...
                            if (activity.leadPageId != null &&
                                activity.leadPageId!.isNotEmpty) {
                              ...
                              activity.subtype != kScheduleTour) {
