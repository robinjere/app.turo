...
class _InquiriesFromBoardState extends State<InquiriesFromBoard> {
  ...
  Future<List<dynamic>> fetchInquiriesFromBoard(int page) async {
    ...
    List<dynamic> tempList =
        await _crmRepository.fetchInquiriesFromBoard(page, perPage);
    if (tempList == null ||
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddNewInquiry(
                      forInquiryEdit: false,
                      addNewInquiryPageListener: (bool refresh) {
                        if (refresh) {
                          loadDataFromApi();
                        }
                      }),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => InquiryDetailPage(
                              ...
                              index: index,
                              inquiryDetailPageListener: (
                                  {int? index, bool refresh = false}) {
                                if (refresh) {
                                  loadDataFromApi();
                                }
                                if (index != null) {
                            ...
                            CRMContactDetail(
                              ...
                              () {
                                takeActionBottomSheet(
                                    context, false, inquiry.leads!.email!);
                              },
                              () {
                                takeActionBottomSheet(
                                    context, true, inquiry.leads!.mobile!);
                              },
                              addBottomPadding: true,
                            ),
                            CRMFeatures(inquiry.minBeds, inquiry.minBaths,
                                inquiry.minArea, inquiry.minPrice),
