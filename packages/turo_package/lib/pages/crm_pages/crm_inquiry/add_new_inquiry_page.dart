...
class _AddNewInquiryState extends State<AddNewInquiry> with ValidationMixin {
    ...
    if (leadsFromBoardList.isNotEmpty) {
      ...
      if (widget.forInquiryEdit) {
        ...
        if (leadId != null && leadId.isNotEmpty) {
          Map map = contactList.firstWhere((element) => element["id"] == leadId,
              orElse: () => {});
          if (map.isNotEmpty) {
                      ...
                      children: [
                        ...
                        CardWidget(
                          ...
                          child: Column(
                            children: [
                              headerTextWidget(
                                  UtilityMethods.getLocalizedString("address")),
  ...
  Widget dropDownWidget(
      String text, List list, String key, String? initialValue) {
  ...
  Widget inquiryTypeWidget() {
    return _inquiryTypesList.isEmpty
        ? Container()
        : Container(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items:
                        _inquiryTypesList.map<DropdownMenuItem<String>>((item) {
                      return DropdownMenuItem<String>(
                        child: GenericTextWidget(
    ...
    return ButtonWidget(
        ...
        onPressed: () async {
          if (formKey.currentState!.validate()) {
            ...
            if (widget.forInquiryEdit) {
              addInquiryInfoMap[UPDATE_INQUIRY_ID] =
                  widget.inquiries!.enquiryId!;
            } else {
              addInquiryInfoMap[INQUIRY_ACTION] = INQUIRY_ACTION_ADD_NEW;
            }

            final response =
                await _crmRepository.fetchAddInquiryResponse(addInquiryInfoMap);
    ...
    if (country != null && country.isNotEmpty) {
      ...
      if (countryItem == null && statesData is List) {
        ...
        for (var state in statesData) {
          if (state.parentTerm.toLowerCase() ==
                  countryItem!.slug!.toLowerCase() ||
              state.parentTerm.toLowerCase() ==
    ...
    if (state != null && state.isNotEmpty) {
      ...
      if (stateItem == null && cityData is List) {
        ...
        for (var city in cityData) {
          if (city.parentTerm.toLowerCase() == stateItem!.slug!.toLowerCase() ||
              city.parentTerm.toLowerCase() == stateItem.name!.toLowerCase()) {
    ...
    if (city != null && city.isNotEmpty) {
      ...
      if (cityItem == null && areaData is List) {
        ...
        for (var city in areaData) {
          if (city.parentTerm.toLowerCase() == cityItem!.slug!.toLowerCase() ||
              city.parentTerm.toLowerCase() == cityItem.name!.toLowerCase()) {
            _areaList.add(city);
          }
        }
      } else {
