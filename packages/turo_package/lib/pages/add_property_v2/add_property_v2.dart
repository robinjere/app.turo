...
import 'package:turo_package/models/form_related/houzi_form_item.dart';
...
import 'package:turo_package/widgets/form_widgets/form_page_widget.dart';
...
class _AddPropertyV2State extends State<AddPropertyV2>
                      ...
                      Flexible(
                        ...
                        child: ButtonWidget(
                          ...
                          onPressed: () {
                            ...
                            if (formStateKeysList[(_currentPage)]
                                .currentState!
                                .validate()) {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      ShowDialogBoxWidget(
        ...
        content: Column(
          ...
          children: <Widget>[
            GenericTextWidget(
                "You cannot add a property in your current membership plan."),
            SizedBox(
              height: 10,
            ),
            ButtonWidget(
  ...
  bool isFormPageAllowedForCurrentUser(HouziFormPage formPage) {
    ...
    if (formPage.enable) {
      if (formPage.allowedRoles != null && formPage.allowedRoles!.isNotEmpty) {
