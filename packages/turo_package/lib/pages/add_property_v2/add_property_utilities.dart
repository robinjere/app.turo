...
class AddPropertyUtilities {
  static Map<String, dynamic> convertArticleToMapForEditing(Article article) {
    ...
    Map<String, dynamic> propertyCustomFieldsMap =
        article.propertyInfo!.customFieldsMapForEditing ?? {};
    List<dynamic> propertyFeaturesListFromArticle =
        article.features!.featuresList ?? [];
    ...
    List<dynamic> additionalDetailsList =
        article.features!.additionalDetailsList ?? [];
    ...
    var listOfFeatures = UtilityMethods.getIdsForFeatures(
        propertyFeaturesList, propertyFeaturesListFromArticle);
    ...
    _convertedArticle = {
      ...
      ADD_PROPERTY_DESCRIPTION:
          UtilityMethods.stripHtmlIfNeeded(article.content ?? ""),
      ...
      ADD_PROPERTY_SIZE: article.features!.propertyArea ?? "",
      ADD_PROPERTY_SIZE_PREFIX: article.features!.propertyAreaUnit ?? "",
      ADD_PROPERTY_LAND_AREA: article.features!.landArea ?? "",
      ADD_PROPERTY_LAND_AREA_PREFIX: article.features!.landAreaUnit ?? "",
      ...
      ADD_PROPERTY_VIRTUAL_TOUR:
          article.propertyInfo!.propertyVirtualTourLink ?? "",
      ADD_PROPERTY_FAVE_PROPERTY_MAP: '',
      ADD_PROPERTY_FLOOR_PLANS: getFloorPlansList(floorPlansList),
      ADD_PROPERTY_ADDITIONAL_FEATURES:
          getAdditionalDetailsList(additionalDetailsList),
      ...
      ADD_PROPERTY_FAVE_AGENT_DISPLAY_OPTION:
          article.propertyInfo!.agentDisplayOption ?? "",
      ...
      ADD_PROPERTY_PRIVATE_NOTE: article.propertyInfo!.privateNote,
      ADD_PROPERTY_SHOW_PRICE_PLACEHOLDER:
          article.propertyInfo!.showPricePlaceholder == true ? 'on' : '0',
      ADD_PROPERTY_PRICE_PLACEHOLDER:
          article.propertyInfo!.pricePlaceholder ?? "",
    ...
    if (multiUnitsListingIDs.isNotEmpty) {
      _convertedArticle[ADD_PROPERTY_FAVE_MULTI_UNITS_IDS] =
          multiUnitsListingIDs;
    }
  ...
  static List<Map<String, dynamic>> getAdditionalDetailsList(
      List<dynamic> list) {
    if (list != null && list.isNotEmpty) {
