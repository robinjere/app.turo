...
import 'package:turo_package/pages/send_email_to_realtor.dart';
...
typedef PropertyProfileBottomButtonActionBarListener = void Function(
...
class PropertyProfileBottomButtonActionBar extends StatefulWidget {
  ...
  final PropertyProfileBottomButtonActionBarListener?
  ...
  @override
  State<PropertyProfileBottomButtonActionBar> createState() =>
      _PropertyProfileBottomButtonActionBarState();
}

class _PropertyProfileBottomButtonActionBarState
    extends State<PropertyProfileBottomButtonActionBar> {
  int? tempRealtorId;
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              top: AppThemePreferences()
                  .appTheme
                  .propertyDetailsPageBottomMenuBorderSide!,
            ),
          ),
          child: SafeArea(
            top: false,
              ...
              child: !widget.isInternetConnected
                  ...
                  : (showSmallActionButtons())
                      ? SmallActionButtons(
                          ...
                          showWhatsAppButtonPadding:
                              showWhatsAppButtonPadding(),
                          showLineButtonPadding: showLineButtonPadding(),
                          showTelegramButtonPadding:
                              showTelegramButtonPadding(),
  ...
  onWhatsAppButtonPressed() async {
    ...
    tempRealtorWhatsApp =
        tempRealtorWhatsApp.replaceAll(RegExp(r'[()\s+-]'), '');
...
class SmallActionButtons extends StatelessWidget {
  ...
  Widget emailElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "small_email_button") ??
        SmallButtonWidget(
  ...
  Widget callElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "small_call_button") ??
        SmallButtonWidget(
  ...
  Widget whatsappElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "small_whatsapp_button") ??
        SmallButtonWidget(
  ...
  Widget lineAppButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "small_line_button") ??
        SmallButtonWidget(
  ...
  Widget telegramButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "small_telegram_button") ??
        SmallButtonWidget(
...
class LargeActionButtons extends StatelessWidget {
  ...
  Widget emailElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(context, article, "email_button") ??
        ButtonWidget(
          maxLines: 1,
  ...
  Widget callElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(context, article, "call_button") ??
        ButtonWidget(
          maxLines: 1,
  ...
  Widget whatsappElevatedButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "whatsapp_button") ??
        ButtonWidget(
          maxLines: 1,
  ...
  Widget lineAppButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(context, article, "line_button") ??
        ButtonWidget(
          maxLines: 1,
  ...
  Widget telegramButtonWidget(BuildContext context, Article? article) {
    return HooksConfigurations.widgetItem(
            context, article, "telegram_button") ??
        ButtonWidget(
          maxLines: 1,
