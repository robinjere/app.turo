...
import 'package:turo_package/models/property_detail_page_widget.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_attachments.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_contact_information.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_address.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_address_detail.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_description.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_enquire_info.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_features.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_features_details.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_floor_plans.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_images.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_related_listing.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_setup_tour.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_static_map_address.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_status_and_price.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_sub_listing.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_title.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_valued_features.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_virtual_tour.dart';
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_watch_video.dart';
import 'package:turo_package/widgets/review_related_widgets/reviews_widget.dart';

typedef PropertyDetailsPageWidgetsListener = void Function(
    Map<String, dynamic> propertyDetailsPageDataMap, bool dataLoaded);
...
class _PropertyDetailsPageWidgetsState
  ...
  void initState() {
    ...
    _isPropertyProfileItemEnable =
        propertyDetailsPageMap[WIDGET_ENABLED_PROPERTY_PROFILE];
    _propertyProfileItemType =
        propertyDetailsPageMap[WIDGET_TYPE_PROPERTY_PROFILE];
    _propertyProfileItemTitle =
        propertyDetailsPageMap[WIDGET_TITLE_PROPERTY_PROFILE];
    _propertyProfileItemViewType =
        propertyDetailsPageMap[WIDGET_VIEW_TYPE_PROPERTY_PROFILE] ?? "";
  ...
  Widget build(BuildContext context) {
    ...
    if ((checkCondition(CONTACT_INFORMATION_PROPERTY_PROFILE) ||
            checkCondition(BUTTON_GRID_PROPERTY_PROFILE)) &&
        realtorInfoMap.isEmpty &&
            ...
            if (SHOW_REVIEWS) {
              return Padding(
                ...
                child: ReviewsWidget(
                  ...
                  totalRating:
                      getRating(_article!.propertyInfo!.houzezTotalRating),
                  link: _article!.link == null || _article!.link!.isEmpty
                      ? _articleLink
                      : _article!.link,
                  title: _article!.title == null || _article!.title!.isEmpty
                      ? _title
                      : _article!.title,
                  type: _article!.type == null || _article!.type!.isEmpty
                      ? type
                      : _article!.type,
