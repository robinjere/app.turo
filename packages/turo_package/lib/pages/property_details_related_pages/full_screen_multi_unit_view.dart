              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    showDataWidget(
                        faveMuType, AppThemePreferences.locationCityIcon),
                    showDataWidget(faveMuAvailabilityDate,
                        AppThemePreferences.availabilityIcon),
                    showBedAndBathData(
                        faveMuPrice,
                        AppThemePreferences.priceTagIcon,
                        "$faveMuSize $faveMuSizePostfix",
                        AppThemePreferences.areaSizeIcon),
                    showBedAndBathData(faveMuBeds, AppThemePreferences.bedIcon,
                        faveMuBaths, AppThemePreferences.bathtubIcon),
                  ],
                ),
              ),
            );
