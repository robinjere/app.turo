...
class ScheduleTourState extends State<ScheduleTour> with ValidationMixin {
  ...
  final TextEditingController _textEditingControllerForDate =
  ...
  loadData() {
    setState(() {
      ...
      _textEditingControllerForDate.text =
  ...
  fetchNonce() async {
    ApiResponse response =
        await _propertyBloc.fetchScheduleATourNonceResponse();
    if (response.success) {
  ...
  Widget tourInformationTextWidget() {
    return headingWidget(
        text: UtilityMethods.getLocalizedString("tour_information"));
  }
  ...
  Widget timeSlotPicker() {
    return _scheduleTimeSlotsList == null || _scheduleTimeSlotsList.isEmpty
        ? Container()
  ...
  Widget yourInformationTextWidget() {
    return headingWidget(
        text: UtilityMethods.getLocalizedString("your_information"));
  }
  ...
  onSubmitPressed() async {
    if (formKey.currentState!.validate()) {
      ...
      final response =
          await _propertyBloc.fetchScheduleATourResponse(dataMap, nonce);
