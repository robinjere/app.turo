        ...
        body: widget.imageUrls[0] != null
            ? Stack(
                children: [
                      ...
                      child: InteractiveViewer(
                        ...
                        child: Center(
                          child: widget.floorPlan == true
                              ? imageListPageView(
                                  context: context, list: widget.imageUrls)
                              : Hero(
                                  tag: widget.tag,
                                  child: imageListPageView(
                                      context: context, list: widget.imageUrls),
                                ),
                        ),
                      ),
                  ...
                  widget.floorPlan == true
                      ? Container()
                      : imageIndicatorsWidget(list: widget.imageUrls),
