...
import 'package:turo_package/pages/property_details_related_pages/full_screen_multi_unit_view.dart';
...
class _PropertyDetailPageSubListingState
  ...
  Widget build(BuildContext context) {
    ...
    return subListingsPosts(
        _futureSubListingArticles, widget.title, widget.widgetViewType);
  }

  Widget subListingsPosts(Future<List<dynamic>>? futureSubListingsArticles,
