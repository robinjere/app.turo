...
class SimpleDescriptionWidget extends StatefulWidget {
  ...
  @override
  State<SimpleDescriptionWidget> createState() =>
      _SimpleDescriptionWidgetState();
}
...
class HTMLEnableDescriptionWidget extends StatefulWidget {
  ...
  @override
  State<HTMLEnableDescriptionWidget> createState() =>
      _HTMLEnableDescriptionWidgetState();
}

class _HTMLEnableDescriptionWidgetState
    extends State<HTMLEnableDescriptionWidget> {
  String title = "";
  String content = "";
  bool isReadMore = false;
        ...
        children: [
          ...
          GestureDetector(
            onLongPress: () {
              if (UtilityMethods.isValidString(widget.article.content)) {
                content =
                    UtilityMethods.stripHtmlIfNeeded(widget.article.content!) ??
                        "";
              }
              Clipboard.setData(ClipboardData(text: content));
              ShowToastWidget(
            ...
            child: Container(
              ...
              child: Align(
                  alignment: UtilityMethods.isRTL(context)
                      ...
                      : Alignment.centerLeft,
                  child: isReadMore
                      ? HtmlWidget(contentMore)
                      : HtmlWidget(contentLess)),
            ),
          ),
        ],
      );
