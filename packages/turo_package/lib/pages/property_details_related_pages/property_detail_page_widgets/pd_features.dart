...
import 'package:turo_package/pages/property_details_related_pages/features_list.dart';
...
import 'package:turo_package/widgets/staggeredGridWidget.dart';
...
class PropertyDetailPageFeatures extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageFeatures> createState() =>
      _PropertyDetailPageFeaturesState();
}

class _PropertyDetailPageFeaturesState
    extends State<PropertyDetailPageFeatures> {
  Article? _article;
  ...
  void initState() {
    ...
    _withoutValuesFeaturesCheckList =
        _withoutValuesFeaturesCheckList.toSet().toList();
        ...
        : Center(
            child: Column(
              ...
              children: [
                ...
                featuresWithoutValuesList != null &&
                        featuresWithoutValuesList.isNotEmpty
                    ? SizedBox(
                        height: 110,
                        child: CustomStaggeredGridWidget(
                          crossAxisCount:
                              min(5, featuresWithoutValuesList.length),
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CardWidget(
                                    elevation:
                                        AppThemePreferences.zeroElevation,
