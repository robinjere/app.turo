...
import 'package:turo_package/pages/property_details_related_pages/full_screen_image_view.dart';
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GenericTextWidget(
                        UtilityMethods.getLocalizedString("view_floor_plan"),
                        strutStyle: StrutStyle(
                            height: AppThemePreferences.genericTextHeight),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: CustomStaggeredGridWidget(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        var value =
                            floorPlanDetailsMap[key][FLOOR_PLAN_VALUE] ?? "";
                        return Row(
                            ...
                            Padding(
                              ...
                              child: GenericTextWidget(
                                key == FLOOR_PLAN_PRICE
                                    ? "${HiveStorageManager.readDefaultCurrencyInfoData() ?? '\$'}$value"
                                    : value,
                                strutStyle: StrutStyle(
                                  height: AppThemePreferences.genericTextHeight,
                                ),
