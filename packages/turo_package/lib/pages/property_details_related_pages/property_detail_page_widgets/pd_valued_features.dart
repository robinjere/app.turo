...
class PropertyDetailPageValuedFeatured extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageValuedFeatured> createState() =>
      _PropertyDetailPageValuedFeaturedState();
}

class _PropertyDetailPageValuedFeaturedState
    extends State<PropertyDetailPageValuedFeatured> {
  ...
  Widget valuedFeaturesWidget() {
    return _mapOfFeaturesWithValues.isEmpty
        ? Container()
        : Container(
            height: 50,
            padding: EdgeInsets.fromLTRB(
              ...
              0,
              UtilityMethods.isRTL(context) ? 16 : 0,
              0,
            ),
