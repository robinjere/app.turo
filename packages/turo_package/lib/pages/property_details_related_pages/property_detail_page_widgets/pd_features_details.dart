...
class PropertyDetailPageFeaturesDetail extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageFeaturesDetail> createState() =>
      _PropertyDetailPageFeaturesDetailState();
}

class _PropertyDetailPageFeaturesDetailState
    extends State<PropertyDetailPageFeaturesDetail> {
  Article? _article;
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, int index) {
                    ...
                    if (key == FIRST_PRICE ||
                      ...
                      value = UtilityMethods.priceFormatter(
                          value, "", article!.propertyInfo!.pricePrefix ?? "");
                    }
                    if (key == PROPERTY_DETAILS_PROPERTY_SIZE) {
                      if (UtilityMethods.isValidString(
