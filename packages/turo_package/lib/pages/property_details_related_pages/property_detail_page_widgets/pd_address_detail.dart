...
import 'package:turo_package/pages/property_details_related_pages/full_screen_map_view.dart';
...
class PropertyDetailPageAddressDetail extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageAddressDetail> createState() =>
      _PropertyDetailPageAddressDetailState();
}

class _PropertyDetailPageAddressDetailState
    extends State<PropertyDetailPageAddressDetail> {
  Article? _article;
  ...
  Widget addressWidget(String title) {
    ...
    return addressMap == null || addressMap.isEmpty
        ? Container()
        : Padding(
