...
class PropertyDetailPageStatusAndPrice extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageStatusAndPrice> createState() =>
      _PropertyDetailPageStatusAndPriceState();
}

class _PropertyDetailPageStatusAndPriceState
    extends State<PropertyDetailPageStatusAndPrice> {
  Article? _article;
  ...
  loadData() {
    List _propertyStatusList =
        widget.article.features!.propertyStatusList ?? [];
            ...
            Wrap(
              children: propertyTagsList.map((item) {
                return Padding(
                  ...
                  child: item is bool
                      ? FeaturedTagWidget()
                      : TagWidget(label: item),
                );
              }).toList(),
            )
          else if (_propertyStatus.isNotEmpty)
            TagWidget(label: _propertyStatus),
