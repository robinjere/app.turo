...
class _PropertyDetailPageDescriptionState
    extends State<PropertyDetailPageAttachments> {
  Article? _article;
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child:
                        AttachmentWidgetBody(attachment: attachmentList[index]),
...
class AttachmentWidgetBody extends StatelessWidget {
  ...
  const AttachmentWidgetBody({Key? key, required this.attachment})
      : super(key: key);
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: GenericTextWidget(attachment.name ??
