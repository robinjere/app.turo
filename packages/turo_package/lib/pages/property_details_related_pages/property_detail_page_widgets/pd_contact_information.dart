...
import 'package:turo_package/pages/property_details_related_pages/property_detail_page_widgets/pd_heading_widget.dart';
...
class PropertyDetailPageContactInformation extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageContactInformation> createState() =>
      _PropertyDetailPageContactInformationState();
}

class _PropertyDetailPageContactInformationState
    extends State<PropertyDetailPageContactInformation> {
  Article? _article;
  int? tempRealtorId;
                    ...
                    child: Column(
                      children: realtorInfoList.map((item) {
                        ...
                        tempRealtorLink = isAgent
                            ? item.agentLink ?? ""
                            : item.agencyLink ?? "";
                        return commonContactInfoWidget(
  ...
  Widget commonContactInfoWidget(
      {item, bool fromAuthor = false, String heroId = "1"}) {
    return Row(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: FancyShimmerImage(
                        imageUrl:
                            fromAuthor ? tempRealtorThumbnail : item.thumbnail,
                        boxFit: BoxFit.fill,
                        ...
                        errorWidget: ShimmerEffectErrorWidget(iconSize: 20),
                      ),
                    ),
                  ),
                ),
                              ...
                              builder: (context) => SendEmailToRealtor(
                                informationMap: {
                                  ...
                                  SEND_EMAIL_UNIQUE_ID:
                                      _article!.propertyInfo!.uniqueId!,
                      ...
                      tempRealtorMobile.isEmpty
                          ...
                          : Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  launchUrl(
                                      Uri.parse("tel://$tempRealtorMobile"));
                                },
                                child: CardWidget(
                                  elevation: AppThemePreferences.zeroElevation,
                                  shape: AppThemePreferences.roundedCorners(
