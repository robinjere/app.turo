...
import 'package:turo_package/pages/property_details_related_pages/schedule_a_tour_page.dart';
...
class PropertyDetailPageSetupTour extends StatefulWidget {
  ...
  @override
  State<PropertyDetailPageSetupTour> createState() =>
      _PropertyDetailPageSetupTourState();
}

class _PropertyDetailPageSetupTourState
    extends State<PropertyDetailPageSetupTour> {
  Article? _article;
  int? tempRealtorId;
  String title = "";
  ...
  Widget build(BuildContext context) {
    ...
    title = UtilityMethods.isValidString(widget.title)
        ? widget.title
        : "setup_tour";
