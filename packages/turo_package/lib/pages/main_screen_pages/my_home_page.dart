...
import 'package:turo_package/files/theme_service_files/theme_notifier.dart';
...
import 'package:turo_package/pages/main_screen_pages/compact_uploading_widget.dart';
import 'package:turo_package/providers/state_providers/user_log_provider.dart';
import 'package:turo_package/pages/demo_expired.dart';
import 'package:turo_package/pages/home_page_screens/parent_home_related/home_screen_utilities.dart';
import 'package:turo_package/pages/home_screen_drawer_menu_pages/add_property.dart';
import 'package:turo_package/pages/home_screen_drawer_menu_pages/saved.dart';
...
import 'package:turo_package/pages/main_screen_pages/loading_page.dart';
import 'package:turo_package/push_notif/notif_router.dart';
import 'package:turo_package/widgets/bottom_nav_bar_widgets/bottom_navigation_bar.dart';
    ...
    if (Provider.of<UserLoggedProvider>(context, listen: false).isLoggedIn!) {
      ...
      PropertyBloc().fetchUserPaymentStatus().then((value) {
        if (value.isNotEmpty) {
          ...
          GeneralNotifier()
              .publishChange(GeneralNotifier.USER_PAYMENT_STATUS_UPDATED);
        }
        return null;
      });
      // }
        ...
        floatingActionButton: (uploadingArticle == null &&
            ...
            : Container(
                ...
                child: Column(
                  ...
                  children: [
                    if (uploadingArticle != null)
                      UploadPropertyCompactWidget(
      ...
      for (NavbarItem item in navbarItemsList) {
        ...
        if (item.sectionType == PLACE_HOLDER_SECTION_TYPE) {
          if (item.title != null &&
            ...
            bottomNavBarItemsMap[item.title!] =
                UtilityMethods.fromJsonToIconData(
