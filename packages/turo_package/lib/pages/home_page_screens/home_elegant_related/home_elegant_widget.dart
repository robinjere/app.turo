...
import 'package:turo_package/pages/home_page_screens/home_elegant_related/related_widgets/home_elegant_widgets_listings.dart';

class HomeElegant extends ParentSliverHome {
  final GlobalKey<ScaffoldState>? scaffoldKey;

  const HomeElegant({Key? key, this.scaffoldKey}) : super(key: key);
