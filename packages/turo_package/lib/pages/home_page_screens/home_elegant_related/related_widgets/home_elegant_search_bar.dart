...
typedef HomeElegantScreenSearchBarWidgetListener = void Function(
    {Map<String, dynamic>? filterDataMap});

class HomeElegantScreenSearchBarWidget extends StatefulWidget {
  final HomeElegantScreenSearchBarWidgetListener?
      homeElegantScreenSearchBarWidgetListener;
  ...
  @override
  State<HomeElegantScreenSearchBarWidget> createState() =>
      _HomeElegantScreenSearchBarWidgetState();
}

class _HomeElegantScreenSearchBarWidgetState
    extends State<HomeElegantScreenSearchBarWidget> {
  @override
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    topLeft: UtilityMethods.isRTL(context)
                        ? const Radius.circular(0)
                        : const Radius.circular(10),
                    bottomLeft: UtilityMethods.isRTL(context)
                        ? const Radius.circular(0)
                        : const Radius.circular(10),
                    topRight: UtilityMethods.isRTL(context)
                        ? const Radius.circular(10)
                        : const Radius.circular(0),
                    bottomRight: UtilityMethods.isRTL(context)
                        ? const Radius.circular(10)
                        : const Radius.circular(0),
                    //
                  ),
              ...
              onTap: () {
                navigateToFilterScreen(
                  ...
                  navigateToFilterScreenListener: ({filterDataMap}) {
                    widget.homeElegantScreenSearchBarWidgetListener!(
