...
import 'package:turo_package/pages/home_page_screens/home_elegant_related/related_widgets/home_elegant_search_bar.dart';
import 'package:turo_package/pages/home_page_screens/home_elegant_related/related_widgets/home_elegant_top_bar.dart';
...
class HomeElegantSliverAppBarWidget extends StatefulWidget {
  ...
  @override
  State<HomeElegantSliverAppBarWidget> createState() =>
      _HomeElegantSliverAppBarWidgetState();
}

class _HomeElegantSliverAppBarWidgetState
    extends State<HomeElegantSliverAppBarWidget> {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      systemOverlayStyle: SystemUiOverlayStyle(
          statusBarColor:
              AppThemePreferences().appTheme.homeScreen02StatusBarColor,
          statusBarIconBrightness:
              AppThemePreferences().appTheme.statusBarIconBrightness,
          statusBarBrightness:
              AppThemePreferences().appTheme.statusBarBrightness),
      backgroundColor:
          AppThemePreferences().appTheme.sliverAppBar02BackgroundColor,
      pinned: true,
      ...
      flexibleSpace: LayoutBuilder(
        ...
        return FlexibleSpaceBar(
          ...
          title: HomeElegantScreenSearchBarWidget(
            ...
            widget.homeElegantSliverAppBarListener!(
