...
import 'package:turo_package/pages/city_picker.dart';
import 'package:turo_package/widgets/generic_text_widget.dart';
import 'package:turo_package/widgets/sequential_location_picker_widget.dart';
import 'package:turo_package/widgets/toast_widget.dart';
import 'package:provider/provider.dart';

typedef HomeElegantScreenTopBarWidgetListener = void Function(
...
class HomeElegantScreenTopBarWidget extends StatefulWidget {
  ...
  final HomeElegantScreenTopBarWidgetListener?
      homeElegantScreenTopBarWidgetListener;
  ...
  @override
  _HomeElegantScreenTopBarWidgetState createState() =>
      _HomeElegantScreenTopBarWidgetState();
}

class _HomeElegantScreenTopBarWidgetState
    extends State<HomeElegantScreenTopBarWidget> {
  @override
...
class HomeElegantScreenLocationWidget extends StatefulWidget {
  ...
  @override
  State<HomeElegantScreenLocationWidget> createState() =>
      _HomeElegantScreenLocationWidgetState();
}

class _HomeElegantScreenLocationWidgetState
    extends State<HomeElegantScreenLocationWidget> {
                ...
                child: Column(
                  ...
                  children: [
                    GenericTextWidget(
                        ...
                        style:
                            AppThemePreferences().appTheme.subTitleTextStyle),
                    Container(
                      ...
                      child: Row(
                        children: [
                          AppThemePreferences()
                              .appTheme
                              .homeScreenTopBarLocationFilledIcon!,
                          Expanded(
                            child: Container(
