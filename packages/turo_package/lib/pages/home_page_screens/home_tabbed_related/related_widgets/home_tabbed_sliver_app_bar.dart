...
import 'package:turo_package/pages/home_page_screens/home_tabbed_related/related_widgets/home_tabbed_search_bar.dart';
import 'package:turo_package/widgets/generic_text_widget.dart';
import 'package:turo_package/widgets/notifications_widgets/notification-bell-widget.dart';
...
class HomeTabbedSliverAppBarState extends State<HomeTabbedSliverAppBar>
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      systemOverlayStyle: HomeScreenUtilities()
      ...
      flexibleSpace: LayoutBuilder(
        ...
        return FlexibleSpaceBar(
          ...
          titlePadding: EdgeInsets.only(
              left: UtilityMethods.isRTL(context) ? 15 : padding,
              bottom: 10,
              right: UtilityMethods.isRTL(context) ? padding : 15),
          title: HomeTabbedSearchBarWidget(
              borderRadius: 10.0,
              homeTabbedSearchBarWidgetListener: (filterDataMap) {
                widget.homeTabbedSliverAppBarListener!(
                    filterInfo: filterDataMap);
              }),
                    ...
                    children: [
                      rightBarButtonIdWidgetHook!(context) ??
                          NotificationBellWidget(
                            ...
                            showNotificationDot:
                                widget.receivedNewNotifications,
