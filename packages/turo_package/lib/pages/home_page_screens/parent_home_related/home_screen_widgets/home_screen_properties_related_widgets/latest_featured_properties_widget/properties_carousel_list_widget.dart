...
class PropertiesListingGenericWidget extends StatefulWidget {
  ...
  @override
  State<PropertiesListingGenericWidget> createState() =>
      _PropertiesListingGenericWidgetState();
}

class _PropertiesListingGenericWidgetState
    extends State<PropertiesListingGenericWidget> {
    ...
    return Consumer<ItemDesignNotifier>(
      ...
      if (widget.listingView == homeScreenWidgetsListingSliderView) {
        return SlidingCarousel(
          ...
          enablePageIndicator:
              widget.design.isNotEmpty && widget.design == DESIGN_10
                  ? true
                  : false,
        );
      }
...
class PropertiesCarouselViewWidget extends StatelessWidget {
  final List<dynamic> propertiesList;
  final String design;
  final bool isUserLoggedIn;

  const PropertiesCarouselViewWidget({
    super.key,
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (BuildContext context, int itemIndex) {
              ...
              var heroId =
                  "${item.id}-${UtilityMethods.getRandomNumber()}-CAROUSEL";
...
class PropertiesListViewWidget extends StatelessWidget {
  final List<dynamic> propertiesList;
  final String design;
  final bool isUserLoggedIn;

  const PropertiesListViewWidget({
    super.key,
    required this.isUserLoggedIn,
    required this.propertiesList,
    this.design = DESIGN_01,
        ...
        children: [
          CarouselSlider.builder(
            ...
            itemBuilder: (BuildContext context, int itemIndex, int realIndex) {
              ...
              if (item is Article) {
                var heroId =
                    "${item.id}-${UtilityMethods.getRandomNumber()}-SLIDER";
          ...
          if (widget.enablePageIndicator ?? false)
            Positioned.fill(
              bottom: 30,
              child: Align(
