...
typedef ExplorePropertiesWidgetListener = void Function(
...
class ExplorePropertiesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _listOfPropertiesWithData == null ||
            _listOfPropertiesWithData.isEmpty
        ? Container()
        : Column(
...
Widget explorePropertiesList({
  ...
  return Consumer<ItemDesignNotifier>(
    builder: (context, itemDesignNotifier, child) {
      ...
      return SizedBox(
        height: design == DESIGN_02 &&
                listingView == homeScreenWidgetsListingListView
            ? null
            : exploreByTypeDesign.getExploreByTypeDesignHeight(design: design),
...
String getTermTitle(String dataType, String inputSlug) {
  return UtilityMethods.getPropertyMetaDataItemNameWithSlug(
          dataType: dataType, slug: inputSlug) ??
      "";
}
