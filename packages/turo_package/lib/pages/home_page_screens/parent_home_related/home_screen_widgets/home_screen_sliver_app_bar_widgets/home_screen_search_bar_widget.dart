...
class HomeScreenSearchBarWidget extends StatefulWidget {
  ...
  @override
  State<HomeScreenSearchBarWidget> createState() =>
      _HomeScreenSearchBarWidgetState();
}
      ...
      onTap: () {
        navigateToFilterScreen(
          ...
          navigateToFilterScreenListener: ({filterDataMap}) {
            widget.homeScreenSearchBarWidgetListener!(
...
void navigateToFilterScreen({
  ...
  required final HomeScreenSearchBarWidgetListener
