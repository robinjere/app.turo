...
class _HomeScreenListTileState extends State<HomeScreenDrawerListTile> {
  ...
  Widget build(BuildContext context) {
    final widgetFromHook = HooksConfigurations.drawerMenuItemDesignHook != null
        ? HooksConfigurations.drawerMenuItemDesignHook(
            label: widget.title,
            iconData: widget.iconData,
            selectedItem: widget.selectedHome,
            onTap: widget.fromHook ?? false
                ? () => onTapFromHook(context, widget.checkLogin ?? false,
                    widget.onTap, widget.isUserLoggedIn ?? false)
  ...
  onTapFromHook(BuildContext context, bool checkLogin, VoidCallback? onTap,
      bool isUserLoggedIn) {
    if (checkLogin) {
      if (isUserLoggedIn) {
        onTap!();
