...
import 'package:turo_package/pages/home_page_screens/parent_home_related/home_screen_widgets/home_screen_drawer_widgets/home_screen_drawer_widget/home_screen_drawer_widget_listing.dart';
                          ...
                          child: Container(
                            ...
                            child: GenericTextWidget(
                              ...
                              style: AppThemePreferences()
                                  .appTheme
                                  .homeScreenDrawerTextStyle,
                              strutStyle: const StrutStyle(
                                  height: 1.7, forceStrutHeight: true),
                            ),
                          ),
                        ),
                      ],
                              ...
                              : GestureDetector(
                                  child: ClipRRect(
                                    ...
                                    child: FancyShimmerImage(
                                      imageUrl: widget
                                          .userInfoData[USER_PROFILE_IMAGE],
                                      boxFit: BoxFit.cover,
                                  ...
                                  child: Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Padding(
                                        ...
                                        child: GenericTextWidget(
                                          widget
                                              .userInfoData[USER_PROFILE_NAME],
                                          maxLines: 2,
                                          overflow: TextOverflow.ellipsis,
                                          style: AppThemePreferences()
                                              .appTheme
                                              .homeScreenDrawerUserNameTextStyle,
                                        ),
                                      ),
                                    ),
                                  ),
