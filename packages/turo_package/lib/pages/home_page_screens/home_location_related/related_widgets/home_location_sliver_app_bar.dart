...
import 'package:turo_package/pages/home_page_screens/home_location_related/related_widgets/home_location_search_bar.dart';
import 'package:turo_package/pages/home_page_screens/home_location_related/related_widgets/home_location_search_type_widget.dart';
import 'package:turo_package/pages/home_page_screens/home_location_related/related_widgets/home_location_top_bar.dart';

typedef HomeLocationSliverAppBarWidgetListener = void Function(
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      systemOverlayStyle: SystemUiOverlayStyle(
          statusBarColor:
              AppThemePreferences().appTheme.homeScreenStatusBarColor,
        ...
        return FlexibleSpaceBar(
          ...
          background: Column(
            children: [
              ...
              HomeLocationSearchTypeWidget(homeLocationSearchTypeWidgetListener:
