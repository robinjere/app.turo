...
import 'package:turo_package/widgets/text_span_widgets/text_span_widgets.dart';
  ...
  Widget textVersionInfoWidget() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          GenericTextWidget(UtilityMethods.getLocalizedString("version_text"),
          ...
          text: GenericLinkTextSpanWidget(
            ...
            children: [
              GenericNormalTextSpanWidget(
                  text:
                      " ${UtilityMethods.getLocalizedString("about_app_description_text01")} "),
              GenericLinkTextSpanWidget(text: _appName),
              GenericNormalTextSpanWidget(
                  text:
                      " ${UtilityMethods.getLocalizedString("about_app_description_text02")} "),
              ...
              GenericNormalTextSpanWidget(
                  text:
                      " ${UtilityMethods.getLocalizedString("about_app_description_text03")}"),
            ],
          ),
        ));
  }
    ...
    return Padding(
      ...
      child: GenericLinkWidget(
        linkText: UtilityMethods.getLocalizedString(
            "terms_and_conditions"), //AppLocalizations.of(context).terms_and_conditions,
        onLinkPressed: () {
