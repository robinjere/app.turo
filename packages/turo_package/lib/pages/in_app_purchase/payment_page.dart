          ...
          if (state == null) {
            ...
            return Center(
              child: GenericTextWidget(
                  UtilityMethods.getLocalizedString(state.error)),
            );
...
class InAppPurchaseViewModel {
  ...
  MembershipPackageUpdatedHook membershipPackageUpdatedHook =
      HooksConfigurations.membershipPackageUpdatedHook;
  PaymentSuccessfulHook paymentSuccessfulHook =
      HooksConfigurations.paymentSuccessfulHook;
    ...
    if (purchase.pendingCompletePurchase) {
      ...
      try {
        ...
        ApiResponse apiResponse =
            await PropertyBloc().fetchProceedWithPaymentsResponse(dataMap);
