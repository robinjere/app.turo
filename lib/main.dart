import 'package:turo/hooks_v2.dart';
import 'package:turo_package/turo_main.dart' as turo_package;
...
Future<void> main() async {
  ...
  hooksMap["homeRightBarButtonWidget"] =
      v2Hooks.getHomeRightBarButtonWidgetHook();
  ...
  hooksMap["textFormFieldCustomizationHook"] =
      v2Hooks.getTextFormFieldCustomizationHook();
  hooksMap["textFormFieldWidgetHook"] = v2Hooks.getTextFormFieldWidgetHook();
  hooksMap["customSegmentedControlHook"] =
      v2Hooks.getCustomSegmentedControlHook();
  ...
  hooksMap["membershipPackageUpdatedHook"] =
      v2Hooks.getMembershipPackageUpdatedHook();
  hooksMap["paymentHook"] = v2Hooks.getPaymentHook();
  hooksMap["paymentSuccessfulHook"] = v2Hooks.getPaymentSuccessfulHook();
  hooksMap["addPlusButtonInBottomBarHook"] =
      v2Hooks.getAddPlusButtonInBottomBarHook();
  hooksMap["navbarWidgetsHook"] = v2Hooks.getNavbarWidgetsHook();
  hooksMap["clusterMarkerIconHook"] =
      v2Hooks.getCustomizeClusterMarkerIconHook();
  hooksMap["customClusterMarkerIconHook"] =
      v2Hooks.getCustomClusterMarkerIconHook();
  hooksMap["membershipPayWallDesignHook"] =
      v2Hooks.getMembershipPayWallDesignHook();
  hooksMap["minimumPasswordLengthHook"] =
      v2Hooks.getMinimumPasswordLengthHook();
  hooksMap["agentProfileConfigurationsHook"] =
      v2Hooks.getAgentProfileConfigurationsHook();
  ...
  return turo_package.main(
      "assets/configurations/configurations.json", hooksMap);
}
